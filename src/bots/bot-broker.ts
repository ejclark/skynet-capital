 ...
 * a bot and get something the engine can drive.
 */
export function createBotBroker(bot: Bot): AlpacaBrokerAdapter {
  ...
  return new AlpacaBrokerAdapter(new AlpacaTradingClient(transport));
}
