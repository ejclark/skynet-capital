...
export const MARKET_EVENTS: readonly MarketEvent[] = [
  ...
  },
  {
    ...
    status: "estimate",
    source:
      "EST: treasury.gov Tentative Schedule of Treasury Auctions PDF, text layer decompressed direct 2026-09-05 (plain curl, HTTP 200, 17,195 bytes) — row reads verbatim `2-Year NOTE / Announcement Thursday, October 22, 2026 / Auction Monday, October 26, 2026 / Settlement Monday, November 02, 2026`, 1:00pm ET by Treasury's standing coupon-auction convention (the time is NOT separately sourced). The absence of an R makes it a new issue; the 2Y prices monthly as a new issue and is never reopened. Stays estimate on two counts: a tentative schedule is tentative by construction, and this lane may not self-confirm an event it discovered in-sweep — the confirming primary is the 2026-10-22 announcement itself",
    impact: "medium",
    symbols: [],
    notes:
      "The front-end auction that sells TWO SESSIONS BEFORE fomc-2026-10-28, inside the blackout that opens 10-17 — which is what earns it a row while the 5Y (10-27) and 7Y (10-29) on the same 10-22 announcement do not yet have one. The 2Y is the tenor that actually carries policy-rate risk: on 2026-09-04 it moved +8bp to an intraday 4.416%, the highest since January 2025, on a payroll beat, while the 20Y moved 0bp. Its size is NOT settled in writing the way the October long end is — sb0590's (2026-08-05) Oct-26 anticipated-size row reads 69 for the 2Y, but that row was transcribed by this calendar's own sweeps before the FRN-column correction of 2026-09-05, so treat $69B as unverified against the primary until the 10-22 announcement. Read-it-do-not-trade-it: `symbols: []`, the date is `estimate`, and no house playbook (S1/S2/E1/S3/S4 + G1) is rates-keyed. Discovered during the treasury-20y-bond-2026-10-21 initial-research adjacency sweep (2026-09-05), which found it five days after that auction and unlisted; the 5Y 10-27 and 7Y 10-29 rows of the same schedule were seen in the same fetch and deliberately NOT added, being outside the 5-day adjacency corridor this sweep governs.",
  },
  {
