...
export const MARKET_EVENTS: readonly MarketEvent[] = [
  ...
  },
  {
    ...
    kind: "macro-print",
    title: "ECB Governing Council monetary policy decision (Berlin) — 14:15 CET, presser 14:45",
    date: "2026-09-10",
    status: "estimate",
    source:
      "NEWS: ecb.europa.eu 'Meetings of the Governing Council and the General Council' calendar, read direct 2026-09-05 — lists 09/09/2026 and 10/09/2026 as the monetary policy meeting hosted by the Deutsche Bundesbank in Berlin (Day 1 / Day 2, 'followed by press conference'), with the 2026 monetary-policy set completed by 28-29 October and 16-17 December (Frankfurt). THE DATE IS PRIMARY-VERIFIED AND THE STATUS STILL READS ESTIMATE, deliberately: the confirmed-prefix taxonomy in this file's header carries FED: for the Fed and no slot for any other central bank, so there is no honest confirmed prefix to use. The label understates the certainty, which only widens caution — never the other direction.",
    impact: "medium",
    symbols: [],
    notes:
      "Proposed during the fomc-2026-09-16 pulse-check adjacency sweep (2026-09-05); the calendar carried no non-Fed central-bank entry at all before this. Lands the day before US CPI (cpi-2026-09-11) and six days before the Sep-16 FOMC, inside the US communications blackout (09-05 -> 09-17) — so for one session the ECB presser is the only central-bank voice available to a tape trying to price a ~65%-CME / ~50%-Kalshi US hike. IMPACT IS MEDIUM ON THE TRANSMISSION, NOT THE DECISION: this calendar's names are long-duration US AI-growth assets, and the channel is global duration and the dollar, not a euro-area rate per se. The out-of-Frankfurt venue is the only 2026 monetary-policy meeting held elsewhere, which historically raises the communications-surprise variance slightly. A later pulse should re-read the ECB calendar for the decision time and promote or correct this entry if a confirmed prefix for non-Fed central banks ever exists.",
  },
  {
    id: "ppi-2026-09-10",
    kind: "macro-print",
  ...
  {
    id: "boj-decision-2026-09-18",
    kind: "macro-print",
    title: "Bank of Japan Monetary Policy Meeting decision (MPM Sep 17-18)",
    date: "2026-09-18",
    status: "estimate",
    source:
      "NEWS: boj.or.jp 'Monetary Policy Meetings' schedule page (en/mopo/mpmsche_minu/), read direct 2026-09-05 — lists the September 2026 MPM as 17-18 September, decision published at the meeting's conclusion on the second day; the 2026-09-28 date on the same row is the Summary of Opinions, not the decision. Policy rate 0.75%, its highest since 1995. THE DATE IS PRIMARY-VERIFIED AND THE STATUS STILL READS ESTIMATE for the same reason as ecb-decision-2026-09-10: the confirmed-prefix taxonomy has FED: and no slot for any other central bank. Understating the label only widens caution.",
    impact: "medium",
    symbols: [],
    notes:
      "Proposed during the fomc-2026-09-16 pulse-check adjacency sweep (2026-09-05). Lands two days after the Sep-16 FOMC, the day the US communications blackout lifts, and on quarterly triple-witching (opex-2026-09-18) — three duration-relevant things on one session. THE CHANNEL IS THE CARRY TRADE, NOT JAPAN: a BoJ move at a 0.75% policy rate propagates to this calendar's long-duration AI names through yen funding and global term premium, which is the same transmission the FOMC ledger tracks through the 10Y. It is also the first read on how a foreign central bank marks the US decision it just watched. IMPACT IS MEDIUM, deliberately: the mechanism is real but second-order for a US equity book, and the decision announcement lands overnight ET, so any effect reaches the tape as a 09-18 open — the one session of the quarter where opex pinning is the dominant microstructure. Overnight-ET timing means the statement is technically 09-18 JST; the date here is the JST decision date, matching how the BoJ itself publishes it.",
  },
  {
    id: "opex-2026-09-18",
    kind: "opex",
