...
export const MARKET_EVENTS: readonly MarketEvent[] = [
  ...
  },
  {
    ...
    symbols: [],
    notes:
      "THE EARLIEST OBSERVABLE TELL ON WHETHER THE DORAL SUMMIT HAS CONTENT. Sherpas finalize the leaders' declaration text; this is the last such session before g20-miami-2026-12-14, in the same city, four days ahead of it. That makes it the first dated point at which the surviving G20 ledger's own upgrade flag — 'a pre-announced bilateral carrying a named, dated deliverable' — can actually be observed, and the first at which a Chinese objection of the kind that broke the Asheville chair's statement (2026-08-31/09-01, four paragraphs dissented) would show up in the leaders' text. Filed LOW deliberately and with no price channel claimed: the G20 multilateral track has n=0 measured US-equity effect, and a sherpa meeting is a drafting session, not a decision. Attribution off these dates is impossible anyway — 12-10 is also cpi-2026-12-10 and ercot-data-center-audit-filing-2026-12-10, the day after fomc-2026-12-09 and the day before government-funding-deadline-2026-12-11 / cr-expiry-2026-12-11. Read it as a document tell, never as a trade. Discovered during the g20-summit-doral-2026-12-14 duplicate-resolution pass (2026-09-04).",
  },
  {
