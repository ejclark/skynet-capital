...
export const MARKET_EVENTS: readonly MarketEvent[] = [
  ...
  },
  {
    ...
    status: "estimate",
    source:
      "EST: Treasury primary read direct, filed estimate per this lane's no-self-confirm limit on an event discovered in-sweep. The November 2025 MTS (MonthlyTreasuryStatement_202511.pdf, p.40, downloaded from fiscaldata.treasury.gov/static-data/published-reports/mts/ and text-extracted 2026-09-05) carries the full annual table — 'Listed below are the scheduled release dates for the Monthly Treasury Statement. The Statement is released at 2:00 p.m.' — with 'October 2026 / November 12, 2026'. The same table's own caveat, 'The following release dates are subject to change', plus this lane's rule against confirming its own in-sweep discovery, keep it estimate; the confirming primary is the September-2026 edition's own Scheduled Release page, which publishes ~2026-10, or the October edition itself. The 8th-workday rule that generates these dates was verified exact against the published 2024 and 2026 calendars (20 of 20, zero mismatches) by the mts-august-2026-09-11 initial research. Checked 2026-09-05",
    impact: "medium",
    symbols: [],
    notes:
      "THE CALENDAR CARRIED EXACTLY ONE MTS AND THIS IS THE ONLY DATED NEXT ONE. The September-2026 accounting month has NO scheduled release date in Treasury's own table — footnote (1), 'Release date subject to completion of year-end reporting requirements' — because it is the fiscal-year-end statement, so the series skips from 09-11 to 11-12 as far as any primary will commit. That gap is why this entry matters rather than being a routine next-in-series: it is the next dated read on the deficit trajectory the long-end ledgers keep pricing and never dating. It is also THE SCORING DATE for FT-51, the market-impact null mts-august-2026-09-11 registered — deliberately scored here rather than on its own event because 2026-09-11 collides with CPI at 08:30 and UMich prelim at 10:00, while 11-12 is clean of every tracked event (cpi-2026-11-10 and ppi-2026-11-13 sit either side of it, not on it). Content note for whoever researches it: as month one of FY2027 it carries no y/y-comparable FYTD line, and October MTS deficits are structurally large (Oct-2025 printed $284.3B) because benefit outlays run a full month against a light receipts month — a headline that will read alarming and mostly is not. Tiered medium to match its sibling; the measured evidence there is that this release does not move the tape (56 releases: TLT p=0.249, SPY p=0.689; 35 intraday release windows: TLT p=0.413, SPY p=0.946). Estimate widens caution only — no date-keyed action. Discovered during the mts-august-2026-09-11 pulse-check adjacency sweep (2026-09-05).",
  },
  {
    id: "ppi-2026-11-13",
    kind: "macro-print",
