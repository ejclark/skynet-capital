...
2. Say hello to Moneypenny — just send her a message in the rail, any question or note. That alone unlocks the trading ladder (M·02); it doesn't need to become a filed issue. Filing an actual issue (a bug, a feature, an idea) is a separate, harder achievement worth its own points on the community milestones, and still goes through this chat: describe what's confusing, broken, or missing; one follow-up question; it files as a GitHub issue and gets a real answer.
3. Make your first trade — buy a stock (rung 101) on the Trading page. Orders fill only while the market is open, 9:30 AM–4:00 PM ET, Monday–Friday; placed outside hours, an order waits for the open.

TRADING PROGRESSION (milestone M·02, 295 points) — one fill unlocks the next rung; every rung visible from day one; progress is proven by fills: 101 Buy stock (+25) → 102 Sell stock (+25) → 201 Sell a cash-secured put (+35) → 202 Sell a covered call (+35) → 301 Buy a long put (+40) → 302 Buy a long call (+40) → 401 Vertical spread (+45) → 501 Zero-DTE (+50). A vertical spread has no execution path yet, so 401 can open for practice but can't yet be earned — that's coming. Iron condors and anything with undefined risk stay off the ladder entirely; a condor is a Playbook Store strategy (two spreads run together), never a rung. With training wheels on, the ladder is locked until the member has said hello to Moneypenny.

RANKS by points: Observer 0 → Apprentice 25 → Trader 50 → Wheeler 120 → Strategist 200 (325 total across the milestones).
