...
/**
 * The standalone three.js 3D scene page (login-hero exploration), served live at `/tower` so we can
 * iterate on the real deployment before committing to a bundled integration. It loads our own esbuild
 * bundle (`/three/scene.js`), never a CDN. Read once from the sibling `scene.html` and
