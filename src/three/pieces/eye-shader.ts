...
// The value-noise fbm (2D + 3D) is split into `eye-noise.ts` — purely to stay under Biome's
// file-length budget; it is spliced into GLOBE_FRAGMENT below exactly as it was inline.
import { NOISE } from "./eye-noise.js";
