 ...
 *    on the HTML page until the shell gate learns options plays. `/add`, `/feedback`, `/invite`,
 *    `/claim`, `/ops-status` stay until their phase-9 ports land. `/research/<slug>` documents
