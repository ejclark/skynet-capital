...
this doc defines *what* each assessment does. The postmaster's daily event-research lane
(`.github/workflows/postmaster.yml`, registered in docs/ROUTINES.md) executes it; a human session
following this doc by hand is equally valid.
