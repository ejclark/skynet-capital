...
| 2026-09-21 | D-30 | Pulse check (full session, dispatched by `event-scan.mjs`, not a screen). **Materiality reason: a cadence band transition, not a threshold crossing** — D-30 crosses the medium tier's 31-day boundary, so the interval tightens `medium:31+` (21d) → `medium:8+` (7d). **The single pending item this doc logged as its baseline resolved.** The 2026-09-16 FOMC hiked 25bp to **3.75–4.00%**, unanimous 12–0, with a hawkish SEP (2026 median dot **4.1%**, up from June's 3.8%) — read off the sibling [`fomc-2026-09-16`](fomc-2026-09-16.md) close-out (federalreserve.gov statement + SEP Table 1, re-fetched there), which scored its own `FT-fomc-2026-09-16-4` **KILLED** on that exact gap. D-46 logged this as "the baseline the next pulse diffs against, not information about 10-21"; it is now resolved, hawkish of the market's own pre-meeting pricing. **The direct predecessor on this event's own CUSIP printed, and it sits soft-of-median.** 912810UX4's first reopening (2026-09-15) — re-read this session from the sibling [`treasury-20y-bond-2026-09-15`](treasury-20y-bond-2026-09-15.md) close-out, itself scored from fiscaldata's `auctions_query` — stopped at high yield **5.420%**, bid-to-cover **2.57**, a **+2.0bp tail** against a 5.40% when-issued (secondary; Treasury publishes no primary WI for this tenor); composition direct **30.5%** / indirect **52.1%** (the lowest indirect share since the modern 20-year's 2020 reintroduction) / dealer **16.7%**. Against this doc's own corrected yardstick (**first**-reopening slot, n=14: floor 2.50, median 2.74 — the slot one below this event's own second-reopening slot), 2.57 clears the floor but sits below the median: the "2026-09-15 reopening below 2.50" kill switch did **not** fire, but the print is the soft half of its own distribution, not a clean pass. **Rates — the long end moved, in line with leg 6's framing that this sale sits beside a path/dots meeting rather than inside one.** Treasury's daily par curve (home.treasury.gov CSV, fetched direct today, HTTP 200): 20Y **5.25 (09-04) → 5.38 (09-18, latest posted)**, 30Y **5.24 → 5.34**; **20s30s (20Y−30Y) +1bp → +4bp**, continuing rather than reversing the 20Y-cheapens-against-30Y drift the initial research flagged. 2Y **4.37 → 4.76** (09-18, a fresh 2026 high — sibling [`treasury-2y-note-2026-09-22`](treasury-2y-note-2026-09-22.md)'s own primary read), roughly **3x** the 20Y's move over the same window: consistent with leg 8's read that this sale is a level/supply event, not proof the FOMC specifically repriced the 20Y point. The "hawkish FOMC that re-opens the long end" kill switch carries no numeric bar to test — recorded as informational: the SEP was hawkish and the long end backed up 10–13bp, short of anything this doc would call "re-opened." **Volatility:** VIX **14.81** (09-18 close, Yahoo `^VIX`, cross-read via the 2Y-note sibling's own direct pull) vs **14.53** at D-46 — **+0.28**, inside the 3-point materiality bar; not what made this pulse material. **Peers:** n/a — `symbols: []`. **Geopolitical:** not independently re-swept this pass (budget; nothing surfaced incidentally in the sources read). **Adjacency — corridor 7 → 28 tracked ids (±5 days), no new confirmed high/critical** (`adjacentStrongIds` stays empty — checked every date 10-16→10-26 via `event-scan.mjs --on-date`, nothing above `medium`). Growth is other lanes' own auctions/prints filling in as their dates arrive: `industrial-production`/`tic-monthly` join 10-16; `nahb-hmi` 10-19; `housing-starts`/`jgb-20y-auction`/`pending-home-sales`/`uk-labour-market` 10-20; `treasury-buyback-tips-1y10y`/`uk-cpi`/`uk-ppi`/`uk-public-sector-finances`/`vix-expiration` now share **this event's own 10-21** (`--on-date=2026-10-21` confirms 7 entries that date, none a re-slug); `jgb-liquidity-enhancement-5-11y`/`msft-def14a`/`treasury-coupon-announcement` 10-22; `aapl-iphone-duo-launch`/`japan-cpi`/`uk-consumer-confidence`/`uk-retail-sales` 10-23; `dallas-fed-mfg`/`mwts-benchmark-revision` 10-26. **No new dated adjacency discovered — nothing proposed this pass**, every corridor item already canonical. **Forward test:** `FT-treasury-20y-bond-2026-10-21-1` (clears bid-to-cover 2.60) is unaffected by this pass — it grades the 10-21 print itself, not its 09-15 predecessor — and stays open, scoring 2026-10-22. | — (no change; read-don't-trade holds, the corrected second-reopening-slot yardstick is unchanged) | 2026-09-28 (medium, 8–30d band: every 7d) |
...
<!-- probe-ref: {"symbols":{},"vix":14.81,"daysBand":"medium:8+","adjacentIds":["import-export-prices-2026-10-16","industrial-production-2026-10-16","opex-2026-10-16","tic-monthly-2026-10-16","treasury-primary-dealer-agenda-2026-10-16","fomc-blackout-start-2026-10-17","nahb-hmi-2026-10-19","housing-starts-2026-10-20","jgb-20y-auction-2026-10-20","pending-home-sales-2026-10-20","uk-labour-market-2026-10-20","ecb-quiet-period-start-2026-10-21","treasury-buyback-tips-1y10y-2026-10-21","uk-cpi-2026-10-21","uk-ppi-2026-10-21","uk-public-sector-finances-2026-10-21","vix-expiration-2026-10-21","jgb-liquidity-enhancement-5-11y-2026-10-22","msft-def14a-2026-10-22","treasury-5y-tips-2026-10-22","treasury-coupon-announcement-2026-10-22","aapl-iphone-duo-launch-2026-10-23","japan-cpi-2026-10-23","uk-consumer-confidence-2026-10-23","uk-retail-sales-2026-10-23","dallas-fed-mfg-2026-10-26","mwts-benchmark-revision-2026-10-26","treasury-2y-note-2026-10-26"],"adjacentStrongIds":[],"screenStreak":0} -->
