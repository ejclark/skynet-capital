...
<!-- NOTE on the block above: its "vix" is the last completed CLOSE (2026-09-04, 14.53), not any 2026-09-08
     read. As of this session's 10:11 ET pull the live ^VIX bar had printed 15.69, 15.65 and 15.50 across
     three fetches inside five minutes — it is an in-progress bar, and recording one as the screen's diff
     basis is exactly the defect the 2026-09-08 10:15 ET ledger row documents. -->
