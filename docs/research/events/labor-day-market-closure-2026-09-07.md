...
<!-- NOTE on the block above: its "vix" is the last completed CLOSE (2026-09-04, 14.53), not any 2026-09-08
     read, and it is UNCHANGED at the 13:52 ET pull because no 09-08 close exists yet. The live ^VIX bar
     has now printed 15.74 (07:44), 15.69/15.65/15.50 (10:0x) and 15.28 (13:52) — a fifth value for one
     "close", drifting monotonically toward the 14.53 kill line. Recording an in-progress bar as the
     screen's diff basis is exactly the defect the 10:15 ET and 13:52 ET ledger rows document.
     adjacentIds re-verified 13:52 ET: set-identical at 33, all canonical. -->
