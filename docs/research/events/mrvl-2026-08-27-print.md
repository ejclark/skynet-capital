...
| 2026-08-27 | D-0 | Final pulse before tonight's print; instruments not re-run (pulse, no new print data ahead of the report — re-run belongs to close-out). **Peers/sympathy: NVDA's confirmed beat did NOT transmit positively into MRVL today.** NVDA's Aug-26 beat held overnight (rev $96.2B vs ~$92–95B cons., EPS $2.22 vs $2.09 est., +106% y/y; stock extended to ~+4% at $218.77 on a ~70% FY28 growth guide) — but MRVL itself fell **~3–4% intraday/premarket** ahead of its own print ("Marvell Falls 4% Ahead of August 27 Earnings, Broadcom Slips," Yahoo/247WallSt, checked today), attributed to profit-taking on the rally leader and its ~58x forward P/E (vs AVGO's ~20x) rather than a repricing of NVDA's news — a live complication for FT-1's sympathy conditional, to be scored honestly at close-out from re-run data, not pre-judged here. Macro: Q2 GDP 2nd estimate unchanged at 1.5%; July PCE (landed 8/26) — headline +0.2% m/m (topped consensus), core +0.2% m/m in line, annual 3.7%/3.3% headline/core, both above the Fed's 2% target — indexes eased slightly, yields ticked up on the annual read, Sept hike odds slipped to ~38% from ~40%; no surprise large enough to move the print thesis. Vol: VIX 15.45 close 8/26 (trailing-month range 14.18–20.88) — calm regime, marginally softer than the D-1 ~15.8 read, no term-structure stress. Geopolitical: no new MRVL-specific export-control/tariff action since 8/26; the ~70% cumulative Section-301 chip-tariff stack and the already-tracked 2027 layer are unchanged; no new dated item. Event tape: implied-move reads now spread across sources (TipRanks 10.6%, another 12.4%, another 8.98% — source/methodology dispersion, not a clean signal); whisper $0.97 vs the standing $0.93 EPS / $2.71B revenue consensus (Zacks, matches the operative figure used since D-10 — one Yahoo piece's "87 cents" reads as a stale/non-GAAP mismatch, disregarded); Polymarket beat-probability reads 67.5%–88% across sources, consistent with the D-1 row's 0.88. No new dated adjacency found — Warsh's 8/28 keynote and NVDA's 8/26 print are already tracked; nothing new proposed to `market-events.ts`. | — (S2 flat-by-close, E1 no-open-entry, no options structure, and no post-print chase all stand into tonight's print; today's sympathy-defying weakness is banked as tape context for the close-out, not a pre-judgment) | Close-out after tonight's print (event-passed-unscored — this is the final scheduled pulse) |
