...
<!-- probe-ref: {"symbols":{"CRWV":89.36},"vix":14.53,"daysBand":"medium:8+","adjacentIds":["adp-employment-2026-09-30","advance-economic-indicators-2026-09-30","apple-eu-dma-terms-2026-10-01","boj-summary-of-opinions-2026-10-01","boj-tankan-2026-10-01","census-benchmark-revision-nsa-2026-09-28","chicago-pmi-2026-09-30","construction-spending-2026-10-01","consumer-confidence-2026-09-29","dallas-fed-mfg-2026-09-28","durable-goods-2026-09-25","fhfa-hpi-2026-09-29","g20-trade-ministerial-milwaukee-2026-09-30","gdp-q2-2026-third-2026-09-30","government-funding-deadline-2026-09-30","ism-manufacturing-2026-10-01","jobs-2026-10-02","jolts-2026-09-29","m3-full-report-2026-10-02","new-home-sales-2026-09-24","opec-jmmc-68th-2026-10-04","pce-2026-09-30","retail-benchmark-revision-2026-09-28","scoos-2026-09-24","sp-select-sector-secondary-reweight-2026-09-30","treasury-7y-note-2026-09-24","treasury-buyback-10y20y-2026-10-01","treasury-buyback-20y30y-2026-09-24","treasury-coupon-announcement-2026-10-01","trump-xi-summit-2026-09-24","umich-sentiment-final-2026-09-25","unsc-iran-panel-mandate-expiry-2026-09-26"],"screenStreak":0,"blocked":[]} -->

## At a glance

**TL;DR.** *(D-21 pulse, 2026-09-08 pre-open.)* **The move that made this pulse material was not
CoreWeave's.** CRWV ran **84.23 → 89.36, +6.09%**, past the screen's 5% bar — but the whole of it
landed in two sessions the AI-infrastructure complex moved together on someone else's news:
**09-03 NVIDIA agreed to buy Hugging Face for ~$12.93B** (nvidia's own blog; close expected H1
2027), and on **09-04** CRWV **+5.68%**, MRVL **+7.05%**, MU **+6.10%** against QQQ **+0.18%** and
NVDA itself only **+0.84%**. That is the S1 kill restated in live tape — AI-complex beta, not a
CRWV edge — and no CoreWeave press release, analyst action or conference pre-announcement was
found this session. **The date re-verifies against the primary today** (coreweave.com/
fully-connected-2026, fetched 2026-09-08: "September 29–October 1", Moscone South), and the page
still names **no investor or analyst session** — a customer/developer conference, not a
capital-markets venue. **The attribution problem got worse, not better:** the tracked corridor
within ±5 days of the event went from **10 events to 32** since the last row, ISM Manufacturing
flipped `confirmed`, and the keynote day (**09-30**) still carries PCE + GDP-3rd + the funding
deadline + Chicago PMI + ADP. One real tension is now on the record and is *not* a stance change:
the complex has **sold three verified beats in a row** (NVDA 08-26, MRVL 08-27, AVGO 09-02 — beat
both lines, fell 7.76% intra-hour) while **buying narrative** (the Hugging Face deal). A conference
is narrative, not a print. It still licenses nothing — n=0 CoreWeave-hosted editions, no measured
reaction function, attribution-hostile window.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-21) | Stand aside · E1 | High | Nothing CRWV-keyed trades today; the Fed is in blackout (**09-05→09-17**) and the session's event is the 3Y auction. The 09:30 hour still carries 34.6% of CRWV's daily volatility at −0.159% mean return. | A dated CRWV-specific catalyst inside the session — none exists before **2026-09-29** |
| This week (9/8–9/11) | Stand aside; the fork is **CPI 09-11**, not the conference | High | CRWV is this calendar's most rate-sensitive name (−12.1% on the 08-18 auction day) and the long end is at the highs of this event's life: 10Y **4.807%**, 2Y **4.39%**, Brent **$98.56** (09-08). August CPI consensus splits **+0.4% headline / +0.2% core** — the one shape that resolves nothing. | The **10Y closing above 4.90%** on or before **2026-09-16** with CRWV *not* falling — the rate-duration read weakens on the long end, where last week's front-end test never fired (2Y went **−2bp** across 09-02/09-04) |
| This month (through ~9/30) | Watch the keynote, do not position | Medium | The news-bearing session is **09-30**, not the 09-29 point-date — and the corridor tripled since D-29 (**32** tracked events within ±5 days, from 10), keynote day still carrying PCE + GDP-3rd + the funding deadline + Chicago PMI + ADP (confirmed date; the corridor mixes confirmed and estimate entries). | CoreWeave pre-announcing conference content via an 8-K/PR **before 2026-09-29** — re-checked against the primary **09-08**, nothing found — which would move the news out of the confounded window and make the event separately readable |
| This quarter (through ~11/30) | Watch; guards only (S2 · E1) | Medium | The conference sits **D-41 to D-39** ahead of the est. Nov 9–16 Q3 print window, so it reads as a narrative amplifier, not the source ([aws-reinvent-2026](aws-reinvent-2026.md)) — and the tape now pays for narrative while selling verified beats (NVDA 08-26, MRVL 08-27, AVGO 09-02), which raises the prior on a keynote reaction without supplying a reaction function to size against. | The est. **2026-11-10** print (honest window Nov 9–16) repricing the name regardless of what the keynote says — or a keynote announcement large enough to move the revenue curve, which would kill the amplifier read |

**Signals & conditions** — the buy/sell/hold triggers:

- **No buy signal exists** — S1 pre-print positioning is kill-listed on CRWV, and the 09-03/09-04 tape is the kill's live restatement: CRWV moved with MRVL and MU, not with its own news flow.
...
- **New wrinkle in that channel (narrative, unmeasured):** NVIDIA buying **Hugging Face** (09-03) puts CoreWeave's largest supplier and keynote partner into the AI-developer-platform layer CoreWeave bought **Weights & Biases** to own — the brand this very conference carries. Nothing to size; a question to listen for on 09-30.
...
- **Caution/kill:** no pre-conference long (no measured reaction function exists — n=0 CoreWeave-hosted editions); no reading of any 09-29..10-02 CRWV move as conference-driven while PCE/GDP/the funding deadline/ISM/jobs/ADP sit inside it.
- **`FT-25`'s own limit just got a live demonstration** — a 3-session window with **no** CRWV-specific news (09-02→09-04) produced **+9.05pp** excess vs QQQ, close to the registered p75 of 11.47% and past the 6.51% median. The p90 ±16.02% bar is wide because the name is wide; a pass proves nothing, exactly as registered.
