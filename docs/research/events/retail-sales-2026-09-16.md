...
soft July print did *not* get cleanly bought: yields were little changed as sticky inflation and
fiscal-deficit pressure offset the weak-consumer read — a stagflation tinge. No firm August street
...
- The control group (ex autos, gas, building materials, food services) → the cleanest
  consumer-demand signal and the piece that feeds GDP/PCE goods; the leg most likely to move
  rate-desk positioning on FOMC morning.
...
- **Energy de-escalation** ([`CPI doc`](cpi-2026-09-11.md)'s own kill switch) easing the sticky-inflation
  ...
  that changes how a weak consumer number gets traded.
