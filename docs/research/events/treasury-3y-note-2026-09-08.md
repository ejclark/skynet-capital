...
<!-- probe-ref: {"symbols":{},"vix":14.53,"daysBand":"medium:0+","adjacentIds":["aapl-iphone-18-launch-2026-09-09","buyback-blackout-start-2026-09-12","challenger-job-cuts-2026-09-03","cpi-2026-09-11","ecb-decision-2026-09-10","eia-steo-2026-09-09","fed-waller-outlook-2026-09-03","fomc-blackout-start-2026-09-05","hammack-remarks-2026-09-03","iea-omr-2026-09-11","ism-services-2026-09-03","jobs-2026-09-04","labor-day-market-closure-2026-09-07","missouri-map-ballot-deadline-2026-09-08","mts-august-2026-09-11","opec-momr-2026-09-10","opec-plus-meeting-2026-09-06","ppi-2026-09-10","qss-q2-2026-09-09","sp-rebalance-proforma-2026-09-04","sp-rebalance-proforma-capped-2026-09-11","treasury-10y-note-2026-09-09","treasury-30y-bond-2026-09-10","treasury-buyback-10y20y-2026-09-10","treasury-buyback-increase-2026-09-09","treasury-coupon-announcement-2026-09-03","treasury-coupon-announcement-2026-09-10","umich-sentiment-prelim-2026-09-11","waller-economic-outlook-2026-09-03"],"screenStreak":0,"blocked":[{"url":"https://www.cnbc.com/2026/09/04/treasurys-bonds-nonfarm-payrolls-unemployment-data.html","status":"403","at":"2026-09-07"},{"url":"https://www.cnbc.com/2026/09/07/here-are-the-3-big-things-were-watching-in-this-holiday-shortened-trading-week.html","status":"403","at":"2026-09-07"},{"url":"https://www.cnbc.com/2026/09/06/opec-oil-output-october.html","status":"403","at":"2026-09-07"},{"url":"https://www.upi.com/Top_News/World-News/2026/09/06/oil-OPEC-saudi-arabia-russia-iraq-kuwai-kazakhstan-algeria-oman/7291788725765/","status":"403","at":"2026-09-07"},{"url":"https://www.coindesk.com/markets/2026/09/07/no-friday-s-jobs-report-hasn-t-materially-boost-fed-rate-hike-odds","status":"429","at":"2026-09-07"}]} -->

## At a glance

**TL;DR.** **Every pre-auction input this doc was waiting on has now landed, and none of them turned
the stance.** The auction stops at 1:00pm ET today into a setup *quieter* than the one it was framed
against. **(1) Supply is closed three ways.** $58,000,000,000, CUSIP 91282CRL7 — the ninth straight
$58B new issue — now populated in **both** Treasury structured feeds (`offering_amt`, stamped 09-03
11:08 ET), not only in the PDF this doc read at D-3. **FT-20 is live, not void, and scores today.**
**(2) OPEC+ held, which was the last live lever.** The 09-06 release (primary, opec.org) keeps October
production at September's level; the falsifier this doc carried for the week — a supply *cut* — did
not fire. **(3) Oil rose anyway, and that is the session's real finding.** Brent went **95.83 (09-04)
→ ~97.5 (09-07)**, a six-week high, *through* a quota hold **and** through Iran saying a Hormuz
shipping deal with Oman is "days away" — two headlines that should each have deflated the premium.
Tanker traffic is the lowest since May; the quota is no longer setting the price. **(4) The odds
series resolves clean, and it is flat.** The "~52–61%, sources disagree" this doc carried at D-3 is
now one coherent CME FedWatch series: **70.2% (09-02) → 49.4% (09-03, Waller) → 58% (09-04, payrolls)
→ 58% (09-07)** — **12pp below** the pre-Waller peak, and unchanged over the holiday. **(5) One D-3
read is superseded.** The par curve's 09-04 print, unavailable when that row was written, puts the 3Y
CMT back at **4.45%**, recovering the whole Waller give-back: **+16bp** through the 08-11 stop of
4.291%, not the +12bp and "no longer widening" the last row recorded. Fed blackout runs to 09-17, so
nothing official moves this before the stop. Date stays **estimate** (lane may not self-confirm).
Nothing here is a trade.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-0, stop 1:00pm ET) | Stand aside — everything that could have moved this auction has landed, and none of it turned the stance | High | `symbols: []`. Size closed at **$58B** on three primaries; OPEC+ held; hike odds flat at **58%** through the holiday; the last observable 3Y level is **4.45%** (Treasury par curve, 09-04), **+16bp** through August's 4.291% stop. Still **no dated when-issued yield** published for 09-08 — searched again; the only preview retrievable is Newsquawk's **August** edition. | Today's **1:00pm ET** result printing a bid-to-cover outside **2.54–2.71** — the one observation that says front-end demand does respond to the repricing after all. This is FT-20's kill and it resolves within hours |
| This week | The auction is the **low-variance** leg; the week's risk is **Friday's CPI**, not this stop | High | With OPEC+ resolved and the Fed silent to 09-17, the four-session week is back-loaded onto **PPI 09-10** (core consensus **+0.3% m/m**) and **CPI 09-11**, whose consensus is *split* — headline **+0.4%** energy-led over core **+0.2%**. Which line the market trades decides the FOMC, not this auction. | A **2026-09-11** core CPI at **+0.4% m/m or hotter** — that resolves the split hawkish, takes hike odds toward the ~75% switch, and makes this auction the stale datapoint rather than the fresh one |
| This month | No new duration risk through the **9/8→9/11** block; read the 3Y as a **hike-odds** read | High | Four dated risks in four sessions (3Y 9/8 · 10Y 9/9 · 30Y + PPI + ECB 9/10 · CPI 9/11), into a 9/16 FOMC now priced as a **58%** coin flip. The 3Y's own result is information about the policy leg, not a trade. | A **2026-09-08** bid-to-cover outside the entire 2026 range (below 2.54 or above 2.71), which breaks the inelasticity read this call rests on — this is FT-20's kill, unchanged |
| This quarter | Stand aside on the auction; treat the **front end** as where Fed risk now expresses | Medium | Unchanged and untested since 09-04 (Labor Day intervened): on that day's hot payrolls the 2Y hit **4.4246%** (highest since Jan-2025) while the S&P moved **−0.38%** and **VIX closed 14.53** — where it still sits, no 09-07 print. A policy shock lands in rates and barely touches equity vol. | The **2026-09-16** FOMC moving the S&P ≥1.5% while the 2y moves <5bp — the sibling [`jackson-hole`](jackson-hole-2026-08-28.md) migration test, inherited here |
...
- **Read the tail alongside the cover** (added 09-05, corroborated 09-08 by a second independent
  secondary — Newsquawk's August preview carries the July 3Y at tail −0.6bp, B/C 2.60x, indirect
  67.5% / direct 24.8% / dealer 7.7%, a 5-of-5 match with this ledger's primary-computed shares): the
  last two 3Ys **stopped through**
...
- **The supply leg is closed, now on three primaries** (resolved 09-03; re-verified 09-07): the
  announcement prints **$58B**, the ninth straight, matching the 08-05 refunding guidance — and both
  structured feeds (`fiscaldata upcoming_auctions`, `treasurydirect TA_WS`) now carry the same
  `$58,000,000,000` that D-3 could only read out of the PDF. FT-20's void condition is not met, so it
  scores on 09-08 as registered.
- **No dated when-issued yield exists for 09-08** — searched again 09-07 and found none. The best
  available proxy is the one a **desk preview itself uses**: Newsquawk's August 3Y preview compares
  "the 3-year yield" against the prior auction's high yield, which is exactly this ledger's CMT
  comparison. Applied today: **4.45% (par curve, 09-04) vs the 4.291% August stop, +16bp.**
...
- **The blackout runs to 09-17**: nothing official can soften or confirm anything before the stop, or
  before CPI. **Waller's 09-03 dovish lean remains the last Fed word**, and it is the reason a hot
  payroll print left hike odds 12pp *below* their pre-Waller peak.
- **The hike-odds series is now single-source and flat** (refined 09-08) — CME FedWatch: **70.2%
  (09-02) → 49.4% (09-03, post-Waller) → 58% (09-04, post-payrolls) → 58% (09-07)**. This replaces the
  D-3 row's "~52–61%, sources disagree" with one coherent series and confirms its reading: a 3x jobs
  beat plus $97 Brent left the September call a coin flip. Neither the sub-35% switch nor the ~75%
  switch is close.
- **Oil is a live input to this tenor, and it has stopped taking direction from supply policy.** Brent
  has settled **≥$95 for four straight sessions** (95.63 · 95.52 · 95.83 · **~97.5 on 09-07**, a
  six-week high), rising *through* the OPEC+ hold on 09-06 **and** through Iran's 09-07 statement that
  a Hormuz deal with Oman is days away — two headlines that should each have cut the premium. Hormuz
  tanker traffic is at its lowest since May. **The $95 leg of the oil kill switch fired, and its
  predicted consequence still has not** (see the stance).
- **Equity vol never caught up to rates vol** — VIX **15.20** (09-02) → **14.32** (09-03) → **14.53**
  (09-04), and there is **no 09-07 print** (Labor Day), so 14.53 is the level this auction clears at.
  The divergence the siblings have logged since 08-18 is intact, so an options-shaped hedge over the
  9/9→9/11 stack remains cheap in absolute terms — which is a statement about price, never a reason to
  buy one.
- **Watch (dated) — every pre-auction item is now resolved:** ~~ISM Services + Challenger + 3Y
  announcement 09-03~~ · ~~jobs 09-04~~ · ~~blackout starts 09-05~~ · ~~OPEC+ 09-06 (held; October
  output unchanged)~~ · **this auction 09-08 1:00pm ET** (estimate) · 10Y reopening + iPhone launch +
  buyback increase **09-09** · PPI + 30Y reopening + 10–20Y buyback + ECB decision + **the 20Y/10Y
  coupon announcement 09-10** · **CPI 09-11** · 20Y **09-15** · **FOMC 09-16** · **09-17** (the 09-10
  announcement's second leg, and the blackout's end) · OpEx **09-18**.
...
**Refined 2026-09-08 (D-0, ~15 hours before the 1:00pm ET stop) — same stance; the last live input
resolved in the base case's favour, and one D-3 measurement is superseded.** Base case, stand-aside
and FT-20 all hold, and no new forward test is registered — the stance did not move, so there is no
new prediction to pre-register. Five things moved. (1) **OPEC+ held, so the week's falsifier did not
fire.** The 09-06 opec.org release (primary, press release 1835613, fetched direct) records that the
seven participating countries "decided to maintain September 2026 required production for October
2026," at an unchanged **31.1 mb/d** total target per the wire coverage. The D-3 row's "This week"
call named an OPEC+ supply *cut* as what would prove it wrong; the group held, and the last lever that
could reach this auction before the stop is spent. (2) **Oil rose anyway, which is the finding.**
Brent went **95.83 (09-04) → ~97.5 (09-07)**, a six-week high, rising *through* the quota hold and
*through* Iran's 09-07 statement that a Hormuz shipping deal with Oman is "days away" — two headlines
that should each have deflated the premium. Hormuz tanker traffic is the lowest since May. The
practical reading for this tenor: the oil→inflation channel is no longer taking direction from OPEC+
policy at all, so the tracked 10-04 meeting proposed in this PR is a *monitoring* event and not a
lever. (3) **The odds series resolves to one source and it is flat.** The D-3 row quoted "~52–61%,
sources disagree." CME FedWatch alone gives a coherent series: **70.2% (09-02, pre-Waller) → 49.4%
(09-03, post-Waller) → 58% (09-04, post-payrolls) → 58% (09-07)**. That is **12pp below** the
pre-Waller peak, and a 09-07 read framed it as "effectively mirror[ing] market expectations from a
week ago." The D-3 row's central observation — one dovish governor outweighing a 3x jobs beat and a
$97 oil print — survives on a cleaner measurement than it was written with. (4) **A D-3 read is
superseded, and it cuts against that row.** That row recorded the 3Y giving back 5bp to 4.41% and
"no longer widening," from H.15 data through 09-03. Treasury's own par yield curve carries **09-04**,
which H.15 had not yet published: 3Y CMT **4.46 (09-01) · 4.45 (09-02) · 4.41 (09-03) · 4.45
(09-04)** — the Waller give-back was fully recovered on payrolls, and the 3Y sits **+16bp** through
its 08-11 stop of 4.291%, not +12bp. Labor Day means 4.45% is the last observable level into the
auction; 2s10s **41bp**. (5) **The measurement convention is validated from outside.** Newsquawk's
August 3Y preview prices the auction as "the 3-year yield … above the prior auction's high yield" —
i.e. a desk preview uses the same secondary-yield-vs-prior-stop comparison this ledger built leg 5
on. It is still not a when-issued level, and none dated for 09-08 was findable this session. The
receipt is the D-0 row.
...
- **An oil shock big enough to price a hike outright** (added 2026-09-01) — Brent holding above
  ...
  *(**Trigger fired 2026-09-05, consequence refuted.** Brent settled ≥$95 on 09-02/03/04 — 95.63,
  ...
  the D-7 row that coined it, which stays as written.* **Second confirmation 2026-09-08:** Brent rose
  again to a six-week **~$97.5** on 09-07 — through an OPEC+ hold *and* a Hormuz-deal headline — while
  hike odds stayed pinned at **58%**. Two independent windows now show the price leg moving with the
  odds leg flat, so the restatement stands.)*
...
| 2026-09-08 | D-0 (pre-auction) | Adjacency sweep; band unchanged (**medium:0+**). Session ran **2026-09-07 21:42 ET**, i.e. ~15 hours before the 1:00pm ET stop, on the evening of a **full market closure** (Labor Day, cash Treasuries and equities shut, SIFMA full close) — so the only new tape since the D-3 row is the OPEC+ weekend, the ICE oil session, and Treasury's own feeds. **Event tape — supply confirmed a third way.** Both structured primaries now populate the offering amount that D-3 could only read out of the PDF: fiscaldata `upcoming_auctions` and treasurydirect `TA_WS/securities/upcoming`, re-fetched this session, return the 3-Year at CUSIP **91282CRL7**, `offering_amt` **58000000000**, `reopening: "No"`, announce 09-03 · auction 09-08 · issue 09-15 · maturity **2029-09-15**, treasurydirect `updatedTimestamp` **2026-09-03T11:08:45** (i.e. stamped minutes after the 11:00 embargo lifted). The rest of the block matches too — 9Y-11M reopening **$39B** (91282CRF0) 09-09, 29Y-11M reopening **$22B** (912810UW6) 09-10 — and a third-party week-ahead independently lists the same three sizes. **Ninth consecutive $58B 3Y new issue; FT-20 is not void and scores today.** **Still no dated when-issued yield for 09-08** — searched again across auction-preview publishers; the only preview retrievable is Newsquawk's **2026-08-12** edition (the August auction), re-served by search under a September-looking query and discarded as such. **Method — the WI convention this doc approximates is the desk convention.** That August preview prices the auction as *"The 3-year yield trades around 4.31%, above the prior auction's 4.179% high yield"* — a secondary 3Y yield measured against the prior stop, which is exactly the comparison leg 5 makes with the 3Y CMT and has flagged as not-a-WI in every row. Applied today: **4.45% vs the 4.291% August stop, +16bp.** The same preview also carries the July 3Y at **tail −0.6bp, B/C 2.60x, indirect 67.5% / direct 24.8% / dealer 7.7%** — a **5-of-5** match with this ledger's own primary-computed shares and with the D-3 row's tracker figures, so the n=2 tail metric now has **two independent secondaries** agreeing with the primary on every overlapping field. **Rates — the D-3 row's read is superseded by a reading it could not have had.** Treasury's daily par yield curve (primary, `home.treasury.gov` daily_treasury_yield_curve CSV, fetched direct) carries **09-04**, which H.15 had not yet published when the D-3 row ran: 3Y CMT **4.46 (09-01) · 4.45 (09-02) · 4.41 (09-03) · 4.45 (09-04)**; 2Y 4.39 · 4.39 · 4.34 · **4.37**; 10Y 4.79 · 4.79 · 4.77 · **4.78**; 30Y 5.27 · 5.27 · 5.25 · **5.24**. **The 5bp Waller give-back the D-3 row recorded was fully recovered on payrolls: the 3Y is back at 4.45%, +16bp through its own 08-11 stop of 4.291%, not the +12bp and "no longer widening" that row logged.** 2s10s **41bp**. No 09-07 reading exists (holiday), so 4.45% is the last observable level into the stop. **Macro — the odds series resolves to a single source, and it is flat.** The D-3 row quoted "~52–61%, sources disagree" and picked no point. CME FedWatch alone gives a coherent series across the whole window: **~68% (09-01) · 70.2% (09-02) · 49.4% (09-03, post-Waller) · 58% (09-04, post-payrolls) · 58% (09-07)**. The 70.2%/49.4%/58% legs are wire-sourced (the CNBC and CoinDesk originals both refused direct fetch — 403 and 429, recorded in `probe-ref.blocked`; figures taken from search summaries of those articles and cross-checked against three further outlets carrying 58%/58.4%). **Net: 12pp BELOW the pre-Waller peak, and unchanged through the holiday** — a 09-07 read put it that current pricing "effectively mirrors market expectations from a week ago," which is the D-3 row's own observation reached independently. **Geopolitical/oil — the week's falsifier did not fire, and oil rose regardless.** OPEC+ **held**: opec.org press release **1835613 dated 6 September 2026** (primary, fetched direct) records that the seven participating countries *"decided to maintain September 2026 required production for October 2026"* and closes *"The next meeting will be held on 4 October 2026."* Wire coverage puts the unchanged total target at **31.1 mb/d**. The D-3 "This week" call named an OPEC+ supply **cut** as its falsifier; it did not happen. **But Brent went 95.83 (09-04) → ~97.5 (09-07), a six-week high (~97.0 on the 09-08 Asian session), rising THROUGH the quota hold AND through Iran's 09-07 statement that a Hormuz shipping deal with Oman is "days away"** — two headlines that each should have cut the premium. Hormuz tanker traffic is at its lowest since May, and an analyst quoted on the meeting said OPEC+ "currently has very limited power over the physical oil market." **Four consecutive settles ≥$95.** So the oil kill switch's price leg fires harder while its odds leg stays flat at 58% — a second independent window confirming the D-3 restatement that the **odds** leg alone is the operative trigger. **Volatility regime:** VIX **14.53** (09-04 close) and **no 09-07 print** — Δ **0.00** against the probe-ref, the first genuinely unchanged reading this ledger has logged. Equity vol has still not caught up to rates vol. **Week shape — sharpens "the auction is the weather, CPI is the climate."** Four sessions, back-loaded: consensus has August **headline CPI +0.4% m/m** (energy-led) over **core +0.2%**, and **core PPI +0.3% m/m** (one write-up reads that as core PCE to ~4.6% y/y). A *split* consensus is what makes 09-11 the week's real risk rather than this stop. The **Fed blackout runs 09-05 → 09-17**, and the **ECB is expected to hike 25bp on 09-10**. **Peers:** n/a, `symbols: []`. **Adjacency — six ids newly inside the 5-day corridor since the last probe-ref, all six already tracked** (`ecb-decision-2026-09-10`, `iea-omr-2026-09-11`, `labor-day-market-closure-2026-09-07`, `missouri-map-ballot-deadline-2026-09-08`, `opec-momr-2026-09-10`, `qss-q2-2026-09-09`), and the D-3 row's own proposal `treasury-coupon-announcement-2026-09-10` has since landed as a canonical entry. **One genuinely new dated event PROPOSED (`estimate`):** `opec-plus-meeting-2026-10-04` — the quota-setting seven-country group's own next meeting, named verbatim in the 09-06 release. It is **not** the already-tracked `opec-jmmc-68th-2026-10-04`, which meets the same day and whose own notes say the JMMC "does not set quotas, which is the seven/eight-country group's job" — the calendar was tracking the advisory body and not the deciding one. **Flagged, not fixed** (it belongs to `treasury-coupon-announcement-2026-09-10`, not here): treasurydirect types CUSIP **91282CRE3** — announce 09-10, auction 09-17, issue 09-30 — as `securityType: "Note"`, term **9-Year 10-Month**, while the D-3 row recorded it as a 10Y **TIPS** reopening; the end-of-month issue date is TIPS-shaped, the type field is not. **FT-20 unchanged, live, and scoreable today; no new forward test registered** — the stance did not move. | **Refined, not reversed** — base case, stand-aside and FT-20 all hold into the stop. OPEC+ **held**, so the week's falsifier did not fire; Brent nevertheless made a six-week high through both a quota hold and a de-escalation headline; hike odds resolve to a single flat **58%** series, 12pp under the pre-Waller peak; and the D-3 row's "gave back 5bp, no longer widening" is **superseded** by the 09-04 par curve — the 3Y is back at **4.45%, +16bp** through its own August stop | **2026-09-09** — the event passes at 09-08 1:00pm ET, so the next assessment is the `event-passed-unscored` **close-out** (`closeOutWithinDays: 6`), scoring FT-20 from re-run primary auction data, never from memory |
