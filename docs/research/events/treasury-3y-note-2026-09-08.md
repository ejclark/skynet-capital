...
<!-- probe-ref: {"symbols":{},"vix":15.2,"daysBand":"medium:0+","adjacentIds":["aapl-iphone-18-launch-2026-09-09","challenger-job-cuts-2026-09-03","cpi-2026-09-11","eia-steo-2026-09-09","fomc-blackout-start-2026-09-05","hammack-remarks-2026-09-03","ism-services-2026-09-03","jobs-2026-09-04","opec-plus-meeting-2026-09-06","ppi-2026-09-10","treasury-10y-note-2026-09-09","treasury-30y-bond-2026-09-10","treasury-buyback-10y20y-2026-09-10","treasury-buyback-increase-2026-09-09","waller-economic-outlook-2026-09-03"],"screenStreak":0} -->
...
speech this century (JPM). The measurable consequence, now measured **like-for-like** instead of by
2Y proxy: the Fed's own H.15 carries the **3-year constant maturity at 4.46% on 09-01**, **+17bp
through** where the last 3Y actually cleared (the 2026-08-11 auction stopped at **4.291%**) — and the
front end has given none of it back, adding +6bp on 09-01 alone. Since then a *second* driver
arrived: the 2026-08-30 US strike on Larak Island re-escalated the Strait of Hormuz, Brent reached
**~$95**, and September hike odds ran to **~65–68%**. So Sep-8 is the **first supply test of the post-Warsh front end**,
...
*highest* yield. **The supply half is now near-settled in writing:** Treasury's 2026-08-05 refunding
statement says it "anticipates maintaining nominal coupon and FRN auction sizes for at least the next
several quarters," so a 09-03 announcement moving off $58B would mean breaking month-old published
guidance. Date is **estimate** (lane may not self-confirm) but is verified against two Treasury
primaries. Nothing here is a trade.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-5) | Stand aside | High | `symbols: []`, and this assessment runs at **00:32 ET**, so the whole 09-03 stack is still ahead of it — Challenger 07:30 · Waller 08:30 · ISM Services 10:00 · **the 3Y announcement ~11:00** · Hammack 15:00. Both Treasury feeds still return `offering_amt: null` as of this session, so the size is unknown and no WI yield exists. | The **09-03 announcement** (later today) moving the 3Y off $58B — this row's "unknowable" claim expires at 11:00 ET, and the 09-05 pulse is what reads it |
| This week | Watch the **09-04 jobs print** first, then the **09-06 OPEC+ meeting**; the 09-03 announcement is now the low-variance leg | Medium | Payrolls is genuinely two-sided and is the biggest input: consensus **+50–55K**, but the labor leg has been softening under the hawkish repricing (ADP **+38K** vs ~47K, weakest since January; JOLTS 7.27M light) while the inflation leg runs hot (ISM prices-paid 71.1; the 09-02 Beige Book names energy costs across districts). Supply is the leg that got *quieter*: Treasury's own 08-05 guidance points to $58B holding. | The **2026-09-03** announcement raising the 3Y above $58B — still the cleanest single falsifier, now requiring Treasury to break published month-old guidance |
...
- **The 09-03 announcement is the supply tell, and Treasury has pre-announced its answer**: $58B has
  been the constant all year, and the 2026-08-05 refunding statement commits in writing to
  "maintaining nominal coupon and FRN auction sizes for at least the next several quarters." Any
  change is still new information about the issuance path — it is just now a low-probability tail.
...
- **Oil is now a live input to this tenor** — a Hormuz supply shock feeds the inflation leg the
  ...
  Brent **94.86** on 09-02, just under the $95 kill-switch line and not yet *holding* above it.
- **The inflation and labor legs now point opposite ways** (added 09-03) — the front end is pricing a
  hike off energy/prices-paid while ADP, JOLTS and the Beige Book all show labor cooling. That is why
  **09-04 payrolls** is the auction's largest input, and why the sub-35% kill switch is live rather
  than theoretical: the 08-07 July jobs miss already tumbled these same odds once.
- **Equity vol is finally catching up to rates vol** — VIX 14.92 (08-31) → 16.34 (09-01) → **17.17**
  (09-02). Still calm in absolute terms, but the YTD-low divergence the siblings logged since 08-18 is
  closing, which raises what any options-shaped hedge over the 9/8→9/11 stack costs.
...
- **The 09-03 announcement moves the size off $58B** — supply becomes a live variable for the first
  ...
  *(Prior downgraded 2026-09-03: Treasury's 08-05 refunding statement guides to unchanged nominal
  coupon sizes "for at least the next several quarters," so this now needs a guidance break. It stays
  on the list because a switch that fires rarely is still the switch that matters when it fires.)*
