...
| 2026-09-18 | D-14 | **Pulse — cadence band tightens `low:15+` → `low:0+`** (crosses the 15-day sill; weekly checks from here). **Macro surprise since the last row:** the FOMC hiked 25bp to 3.75–4.00% on 2026-09-16 (unanimous 12–0, first hike in three years), and the SEP's 2026 median printed **4.1%**, up from June's 3.8 — hawkish, per the sibling close-out [`fomc-2026-09-16`](fomc-2026-09-16.md). No channel to this event: `symbols: []`, no playbook, and the FOMC's own date sits outside this event's 5-day corridor — it sets the regime Leg 3's payrolls-morning collision plays out in, nothing more. CPI printed in-line 09-11 (+0.4% m/m / 3.4% y/y, per [`cpi-2026-09-11`](cpi-2026-09-11.md)'s close-out). **VIX 16.0** live today — read from sibling [`jobs-2026-10-02`](jobs-2026-10-02.md)'s own same-day D-14 pulse rather than re-fetched — vs the **14.53** baseline: +1.47pt, under the 3pt material sill alone. Government-funding checkpoint (09-30) re-checked: still `RESOLVED — AVERTED` (PL 119-103 through 12-11), still filed `estimate` on the schema-prefix gap, not on doubt. **Corridor re-swept at the 5-day window: 59 other tracked ids today (was 29 at D-26)** — calendar growth, not new findings; every confirmed high/critical name in range (`jobs-2026-10-02`, `ism-manufacturing-2026-10-01`, `ism-services-2026-10-05`, `pce-2026-09-30`) was already tracked. No new dated adjacent event found; none proposed this row. Every kill switch keys off 10-02-or-later session/vintage data and stays unreachable at D-14. | — unchanged: stand aside. The hike changes the regime, not the composition-effect (Leg 3) or posted/internal GDPNow (Leg 4) findings, and this event carries no instrument to enter regardless. | 2026-09-25 (low, 0+ band: every 7d) |
