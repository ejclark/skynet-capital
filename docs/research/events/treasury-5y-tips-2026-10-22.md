...
| 2026-09-22 | D-30 | Adjacency sweep. **Event tape.** Schedule PDF re-fetched (home.treasury.gov, HTTP 200) — **byte-identical, 17,195 bytes**, to the 09-05 fetch: terms unchanged, announce 10-15 / auction 10-22 / settle 10-30, still `T` without `R`. Size still **$26B** per `sb0590`; the 2026-10-15 announcement has not happened yet, so nothing here is re-confirmable this pulse. Cadence band **tightened**: `daysUntil` crossed the `assessment-cadence.json` medium tier's 31-day line (47→30), moving `medium:31+` (21d interval) to `medium:8+` (7d interval) — itself one of the deterministic screen's own material triggers, so this pulse would not have screened quietly even absent the macro news below. **Macro surprise — the largest input this pulse, and it is not the artifact's own channel.** The Fed **hiked 25bp to 3.75–4.00%** on 09-16, unanimous, its first hike in three years, hawkish on top (SEP 2026 median **4.1%**, up from June's 3.8) — the [FOMC sibling's close-out](fomc-2026-09-16.md) scored both dots-lag forward tests **KILLED** in the hawkish direction. Treasury's own daily curves (fetched today): since the 09-04 baseline, **real 5Y +33bp (2.17→2.50)**, nominal 5Y +29bp (4.54→4.83), **5-year breakeven −4bp (2.37→2.33)**; 10-year breakeven **2.34**, essentially flat (−1bp). Read plainly: the hike moved real yields, not breakevens — the same real-rate-not-inflation-expectations channel this doc's own mechanism argument depends on, now visible in the live tape ahead of the auction rather than only in the seven-year history. August CPI (09-11) printed **in line** (headline +0.4%/3.4%, core +0.3%/2.4%, a 0.1pp core beat) per the [CPI sibling's close-out](cpi-2026-09-11.md) — priced, not a surprise on its own. **The cheapest out-of-sample check this doc named now has a result.** The kill switch asked whether the 09-17 **10Y TIPS reopening** — a control, since a reopening should show none of the knot effect — would move its own breakeven by ≥±3bp; the [10Y TIPS sibling's close-out](treasury-10y-tips-2026-09-17.md) reads its breakeven **flat at 2.33% across 09-16/17/18** (the FOMC-window move it did carry, −4bp over 09-08→09-18, was **>50% real-leg per its own `FT-...-1`**, i.e. attributed to the hike, not the auction) — **the switch did NOT fire**, so the new-issue-only claim survives its one live out-of-sample test ahead of 10-22 itself. **Volatility regime:** VIX **14.87** (09-21 close, Cboe primary CSV) vs **14.53** at the last row — **+0.34, well inside the 3-point threshold**; no regime shift. **Geopolitical:** Brent round-tripped **~$97 (09-04) → $108 intraday (09-15, Hormuz-strike premium per the FOMC/10Y-TIPS siblings) → ~$97 (09-22)** — a full round trip already unwound; per the same siblings' close-outs the transmission this quarter has run through the Fed's reaction function into real yields, not through breakevens, which is what the flat 5Y/10Y breakeven readings above independently confirm. **Peers:** `symbols: []`, none applicable; no 5Y TIPS print occurred this window (next is this auction itself). **Corridor:** grew **11 → 29** tracked ids purely from sibling filings (housing starts/NAHB/pending-home-sales 10-19/20, JGB 20Y + liquidity-enhancement 10-20/22, UK CPI/PPI/labour-market/public-sector-finances/retail-sales 10-20/21/23, vix-expiration + TIPS buyback 10-21, MSFT DEF14A + coupon announcement 10-22, MWTS benchmark revision 10-26, Case-Shiller/FHFA/new-home-sales 10-27) — **no high/critical-impact entry among them** (all low/medium), so `adjacentStrongIds` stays empty. **No new dated adjacency to propose** — every id the sweep found inside the corridor is already canonical. [`fomc-2026-10-28`](fomc-2026-10-28.md) still reads **hold-modal (~80–85%)** per its own 09-20 screen, unchanged. No stance change; `FT-treasury-5y-tips-2026-10-22-1` stands, score-by 2026-10-23. | — (no change; the reading instruction holds, and its one live out-of-sample check — the 09-17 reopening's flat breakeven — came back supporting rather than refuting it) | 2026-09-29 (medium, 8+d band: every 7d) |
...
<!-- probe-ref: {"symbols":{},"vix":14.87,"daysBand":"medium:8+","adjacentIds":["case-shiller-hpi-2026-10-27","consumer-confidence-2026-10-27","durable-goods-2026-10-27","ecb-bank-lending-survey-2026-10-27","ecb-monetary-developments-2026-10-27","ecb-quiet-period-start-2026-10-21","fhfa-hpi-2026-10-27","fomc-blackout-start-2026-10-17","housing-starts-2026-10-20","jgb-20y-auction-2026-10-20","jgb-liquidity-enhancement-11-39y-2026-10-27","jgb-liquidity-enhancement-5-11y-2026-10-22","msft-def14a-2026-10-22","mwts-benchmark-revision-2026-10-26","nahb-hmi-2026-10-19","new-home-sales-2026-10-27","pending-home-sales-2026-10-20","treasury-20y-bond-2026-10-21","treasury-2y-note-2026-10-26","treasury-5y-note-2026-10-27","treasury-buyback-20y30y-2026-10-27","treasury-buyback-tips-1y10y-2026-10-21","treasury-coupon-announcement-2026-10-22","uk-cpi-2026-10-21","uk-labour-market-2026-10-20","uk-ppi-2026-10-21","uk-public-sector-finances-2026-10-21","uk-retail-sales-2026-10-23","vix-expiration-2026-10-21"],"adjacentStrongIds":[],"screenStreak":0} -->
