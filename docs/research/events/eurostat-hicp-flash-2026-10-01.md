...
**Stance update — 2026-09-18 (D-14, first pulse).** No change to the bottom line: still stand aside,
still no position, no play. Two findings from this pulse's adjacency sweep, neither of which opens a
channel: **(1) the Branch kill has effectively fired, earlier than this doc's own initial research
knew** — [`government-funding-deadline-2026-09-30`](government-funding-deadline-2026-09-30.md)'s own
TL;DR now reads *"Resolved: this event is averted"*; H.R. 6500 was signed **2026-09-02** as **PL
119-103**, a full week *before* this doc's 09-09 initial research treated the lapse as live, and two
Polymarket contracts priced the 10-01 lapse at **0.85–1.05%** as of 09-10. `jobs-2026-10-02` stays
`confirmed`/`high` with no lapse risk, so this entry now reverts fully to the "plain calendar
visibility" case its own Branch kill names — the shutdown branch this doc hedged on 09-09 was never
live at the time of writing. **(2) Energy risk skews toward the upper half of the registered band,
not against it.** Leg 5's energy math anchored on Brent **$99.33** (09-08); a Saudi East-West
pipeline incident spiked crude to an intraday **$107.81** high around 09-10, retreating to
**~$104–105** by 09-17 — still **~5%** above the anchor
([`jobs-2026-10-02`](jobs-2026-10-02.md)'s 09-18 pulse, citing CNBC/HDFC Sky 09-17). This tilts
**FT-…-2**'s registered energy band (16.6–18.9% y/y) toward its upper edge; the registered prediction
is not edited (falsification), the risk is only noted here. The two central-bank/CPI risks this doc
flagged on 09-09 have since resolved as this doc's own energy-hot/core-tame premise expected — ECB
hiked 25bp to **2.50%** (09-10), US CPI printed **3.4% y/y** (09-11), FOMC hiked 25bp to
**3.75–4.00%**, hawkish (09-16) — none of which opens a channel for this `symbols: []` entry.
...
| 2026-09-18 | D-14 | **Adjacency sweep, first pulse.** **Peers:** none, `symbols: []`, unchanged. **Macro — both corridor risks this doc named on 09-09 have resolved:** ECB hiked 25bp to **2.50%** deposit rate, unanimous, 09-10 (`ecb-decision-2026-09-10` close-out); US CPI printed **+0.4% m/m / 3.4% y/y**, 09-11 (`cpi-2026-09-11`); FOMC hiked 25bp to **3.75–4.00%**, hawkish (2026 SEP median **4.1%**, up from 3.8%), 09-16 (`fomc-2026-09-16` close-out). **The sibling final release re-verifies this doc's own base:** `eurostat-hicp-final-2026-09-17` closed out August at headline **3.2%**, core **2.4%**, energy **14.3%**, services **3.0%** — matching leg 5's table within the known press/database wedge; the September forecast (headline ≈3.6%, energy ≈18%, core 2.3–2.4%) needs no revision. **Branch kill effectively fired, earlier than this doc's own initial research knew:** `government-funding-deadline-2026-09-30`'s own TL;DR now reads "Resolved: this event is averted" — H.R. 6500 was signed **2026-09-02** as **PL 119-103**, a week *before* this doc's 09-09 initial research treated the lapse as live, and two Polymarket contracts priced the 10-01 lapse at **0.85–1.05%** as of 09-10. `jobs-2026-10-02` stays `confirmed`/`high`, no lapse risk (its own 09-18 pulse). This entry reverts fully to the "plain calendar visibility" case its own Branch kill names. **Volatility:** VIX closed **15.44** (09-17, `^VIX`, fetched today) vs **15.72** baseline — **−0.3pt**, inside the 3pt bar, still under the **18.00** line FOMC's own vol-null test scored PASS. **Geopolitical — the one genuine update:** Brent ran hotter than the **$99.33** anchor leg 5's energy math used — a Saudi East-West pipeline incident spiked it to an intraday **$107.81** high around 09-10, retreating to **~$104–105** by 09-17 (`jobs-2026-10-02`'s 09-18 pulse, citing CNBC/HDFC Sky 09-17) — still **~5%** above the anchor, tilting **FT-…-2**'s registered energy band toward its upper edge; the registered prediction is not edited, the risk is noted here. **Event tape:** no September euro-area consensus found by any sibling sweep either; the date-correction finding is unchanged. **Cadence band transition:** D-14 crosses the low-impact 15-day threshold, `low:15+` (30d) → `low:0+` (7d) — why this pulse fired ahead of the 10-09 date the initial row named. **Corridor:** grew **41 → 59** tracked ids, all sibling-lane additions already canonical — none newly discovered by this sweep; `adjacentStrongIds` populated for the first time (`pce-2026-09-30`, `ism-manufacturing-2026-10-01`, `jobs-2026-10-02`, `ism-services-2026-10-05`, all confirmed high, all already known at initial research). **No new dated event proposed.** | — (no top-line change; see the 09-18 Stance-update addendum — branch kill effective, energy-forecast risk noted, no position) | 2026-09-25 (low, 0–14d band: every 7d) — in practice the close-out on/after 2026-10-02 arrives first |
