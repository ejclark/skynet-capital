...
into the corridor; a soft print is dovish relief. **The live setup, at D-2:** Chicago PMI — the
closest-timed regional analog — **collapsed to 47.1 on 2026-08-28** against a ~58 consensus and a
57.6 prior, its worst reading of 2026, on the same morning Warsh called the economy "strengthened"
and the market repriced September hike odds from ~35% to ~57–59%. **New this row:** a published
consensus finally exists, and the two forecast surfaces disagree with each other. Sell-side
week-ahead previews put August ISM at **55.8–56.4** — *above* July's 55.6 — and do not mention
Chicago at all; TradingEconomics' calendar carries **55.0**. Polymarket, by contrast, *has* partly
repriced over the weekend: the **53.0–53.9 bin now sits at 14%** while 56.0–56.9 fell 17.6% → **8%**.
So the wagering tape is edging toward the soft tail and the published forecasts have not moved at
all. That gap is the thing to watch on Tuesday; it still does not tell you which side is right.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-2) | Stand aside | High | Nothing name-keyed; `symbols: []`. The Chicago miss widens the outcome distribution without giving a tradable direction, and no session has traded since it landed (8/29–8/30 was a weekend). | Polymarket's August bins repricing sharply toward sub-52 before **2026-09-01** — not yet fired: sub-52 bins total only ~5%, and the weekend's shift went into the 53s, not below 52 |
| This week | Watch — and watch the *gap*, not the headline | Medium | Confirmed 9/1 10:00 ET. The rate-relevant read stays prices-paid + new-orders. The gap is now measurable: published forecasts **55.0–56.4** (aggregator + sell-side previews, neither citing Chicago) against Polymarket carrying **14%** on the 53s. A sub-53 print would therefore be a *large* published-consensus miss, not a mild one. | A soft print — headline back below ~52 with prices-paid under 65 — that leaves 9/16 hike odds *unchanged*, which would prove growth data no longer reprices this Fed |
...
- **The forecast-vs-wager gap (new 2026-08-30).** Published forecasts sit at 55.0–56.4 and ignore
  Chicago; Polymarket carries ~14% on 53.0–53.9 and cut 56.0–56.9 to 8%. If the two converge before
  the print, the surprise is being priced in advance; if they stay split into 10:00 ET, whichever
  side is wrong supplies the reaction — the size of the move, not its direction.
