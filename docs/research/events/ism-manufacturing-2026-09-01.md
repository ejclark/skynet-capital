...
<!-- probe-ref: {"symbols":{},"vix":14.43,"daysBand":"high:0+","adjacentIds":["adp-employment-2026-09-02","avgo-2026-09-02-print","beige-book-2026-09-02","fomc-blackout-start-2026-09-05","ism-services-2026-09-03","jackson-hole-2026-08-28","jobs-2026-09-04","jolts-2026-09-01","mrvl-2026-08-27-print","treasury-7y-note-2026-08-27"],"screenStreak":0} -->

## At a glance

**TL;DR.** The August ISM Manufacturing PMI lands **tomorrow, Tuesday 2026-09-01 at 10:00 ET** —
...
and pressure our long-duration AI names; a soft print is dovish relief. The standing setup is a
contradiction nobody has resolved — Chicago PMI, the closest-timed regional analog, **collapsed to
47.1 on 2026-08-28** against a ~58 consensus, on the same morning Warsh called the economy
"strengthened" and the tape repriced September hike odds ~35% → ~57%. **Two things changed at D-1.**
(1) **The energy leg reversed over the weekend.** US forces struck Iranian rocket launchers on
Larak Island in the Strait of Hormuz on Sunday 8/30 and Brent went back **above $90** (+2.5%),
withdrawing the mild prices-paid-easing argument the last two rows carried — though the August
survey window closed *before* the strike, so that is a September-print input, not tomorrow's.
(2) **Polymarket's modal bin moved down a notch for the first time since seeding** — the **54s now
lead at 32%**, ahead of the 55s at **29%** (36% on Sunday, 28.5% for the five rows before that) —
while published forecasts still sit at **55.0–56.4** and still do not mention Chicago at all. That
forecast-vs-wager gap is the thing to watch into 10:00 ET; it still does not tell you which side is
right.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-1) | Stand aside | High | Nothing name-keyed; `symbols: []`. The Chicago miss and the fresh Hormuz escalation both widen the outcome distribution without giving a tradable direction, and this pulse ran before the 8/31 session closed — the 8/28 closes are still the latest tape. | Polymarket's August bins repricing sharply toward sub-52 before **2026-09-01** — still not fired: sub-52 bins total ~5%, unchanged from D-2, and the drift went into the 54s |
| This week | Watch — and watch the *gap*, not the headline | Medium | Confirmed 9/1 10:00 ET; the rate-relevant read stays prices-paid + new-orders. Published forecasts **55.0–56.4** (neither citing Chicago) against a wager tape whose modal bin is now the **54s at 32%**. A sub-53 print would be a *large* published-consensus miss, not a mild one. | A soft print — headline back below ~52 with prices-paid under 65 — that leaves 9/16 hike odds *unchanged*, which would prove growth data no longer reprices this Fed |
| This month | Watch | Medium | Opens the Sep-1 → Sep-16 corridor (JOLTS same day, Beige Book 9/2, ISM-svcs 9/3, jobs 9/4, PPI 9/10, CPI 9/11). With forward guidance abolished on 8/28 **and the FOMC blackout falling at midnight entering 9/5**, this print is one of only three that a Fed official can still publicly interpret. | A weak JOLTS the same day or a weak jobs print on **2026-09-04** collapsing hike odds toward zero |
...
- **The forecast-vs-wager gap (new 2026-08-30, widened 2026-08-31).** Published forecasts sit at
  55.0–56.4 and ignore Chicago; Polymarket's modal bin is now the 54s at 32%, the 55s at 29%. If the
  two converge before the print, the surprise is being priced in advance; if they stay split into
  10:00 ET, whichever side is wrong supplies the size of the reaction — not its direction.
- **Crude back above $90 after the 8/30 Larak strike** → the disinflationary offset the last two
  rows carried is withdrawn. Read it as a **September**-survey input: August's window closed before
  the strike, so it cannot show in tomorrow's prices-paid reading.
