...
**Kind:** earnings · **Date:** 2026-09-02 (confirmed, IR: broadcom.com/company/news/financial-releases/64621 — Wed Sep 2 AMC, call 2pm PT; directly fetched 2026-08-27) · **Impact:** critical
...
**2026-08-27 update.** The Sep 2 date flipped `estimate` → `confirmed` this row (`src/domain/earnings-calendar.ts`):
a direct fetch of Broadcom's own primary source (broadcom.com/company/news/financial-releases/64621)
succeeded, closing a flip this doc had proposed twice before (2026-08-17, 2026-08-19) without
actioning it. The stance itself is unchanged — the confirmation only firms the existing flat-by-close
deadline, per the date policy (an estimate widens caution; a confirmation doesn't loosen it).
