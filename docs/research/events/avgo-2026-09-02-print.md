...
<!-- probe-ref: {"symbols":{"AVGO":368.79},"vix":14.43,"daysBand":"critical:0+","adjacentIds":["adp-employment-2026-09-02","ism-manufacturing-2026-09-01","ism-services-2026-09-03","jackson-hole-2026-08-28","jobs-2026-09-04","jolts-2026-09-01"],"screenStreak":0} -->
...
2026-08-27, closing a flip proposed twice before and finally actioned this row); implied move
no longer reads as one clean figure — sources span **~7.3%–12.4%** (7.3% Bloomberg · 8.7%
earnings-watcher · 9.0% TipRanks · 12.4% Market Chameleon), against an ~**10.8%** 8-quarter average
realized reaction and a **±7.4%** 10-year average (median ±5.8%): the recent regime runs ~1.5× the
decade norm. All three AI-semis sympathy inputs are now in and **all three are soft**: NVDA's muted AH
...
Revenue that quarter slightly *missed* ($22.19B vs LSEG $22.27B) — only non-GAAP EPS beat. Watch the
Q4 AI guide, the FY27 figure and the software line, not the Q3 headline.
...
| This week | **Flat by the 2026-09-02 close (S2)** | High | The print is now IR-confirmed for the 2026-09-02 close; a 7.3–12.4% implied move is the live price of ignoring the flat rule, and June's damage came in the D+1 *session*, not just the gap | ≥3 new prints showing a repriced gap regime |
...
- **The three numbers that decide the reaction** (corrected 2026-08-30) — the **Q4 AI-semi guide** (June's proximate trigger was a $16B Q3 guide vs ~$17.2B expected), the **FY27 AI target** (">$100B" since Q2; declining to raise it was the second leg), and the **infrastructure-software line** ($7.18B missed $7.32B in June, and it is where the exploited VMware vCenter CVE lands). A raise plus a clean software line is the bull case; a reiteration is the June setup repeating.
- **Watch (dated)** — NVDA print **2026-08-26** (reported; muted AH pop, then −3.40% on **2026-08-28**) · MRVL print **2026-08-27 AMC** (reported; beat, −7.6% AH on margin compression) · Warsh's Jackson Hole keynote **2026-08-28** (delivered, hawkish — Sept hike odds ~35% → 57–59%) · Trump–Xi summit **2026-09-24** (proposed, export-control/AI-governance agenda) · any XPV disclosure in a filing or PR.
