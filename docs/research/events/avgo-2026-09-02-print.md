...
no longer reads as one clean figure — sources span **~7.3%–12.4%** (7.3% Bloomberg · 9.0% TipRanks ·
12.4% Market Chameleon), against an ~**10.8%** 8-quarter average realized reaction. All three AI-semis
sympathy inputs are now in and **all three are soft**: NVDA's muted AH pop then **−3.40%** on 8/28,
MRVL's clean beat that sold off **~7.6% AH** on margin compression, and AVGO itself **−1.56% to
$368.79** on 8/28. **The bar is now a specific number, not a vibe:** at the 2026-06-03 Q2 print AVGO
beat *both* lines and still fell **−12.6% in one session** because management would not raise the FY27
AI target above ">$100B". Watch the FY27 AI figure, not the Q3 beat.
...
- **The one number that decides the reaction** — the **FY27 AI revenue target**. It has stood at ">$100B" since Q2; declining to raise it is what produced the −12.6% session on **2026-06-03** off a double beat. A raise is the bull case; a reiteration is the June setup repeating.
