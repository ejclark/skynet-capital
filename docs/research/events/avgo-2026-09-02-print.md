...
no longer reads as one clean figure — sources now span **~7.3%–12.4%** (widened, not tightened,
since the 8/27 row). Both AI-semis sympathy inputs so far read soft: NVDA's 2026-08-26 print
landed a muted +4–5% AH pop below its own implied move, and MRVL's 2026-08-27 print was a clean
beat that still gave back its gains — neither a strong bullish signal into AVGO's print.
...
- **Watch (dated)** — NVDA print **2026-08-26** (reported, muted AH reaction) · MRVL print **2026-08-27 AMC** (reported, a beat that gave back its gains) · Warsh's Jackson Hole keynote **2026-08-28** (scheduled today, not yet delivered as of this row) · Trump–Xi summit **2026-09-24** (proposed, export-control/AI-governance agenda) · any XPV disclosure in a filing or PR.
