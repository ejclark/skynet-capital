...
**Kind:** rates · **Date:** 2026-09-17 (confirmed, TSY: api.fiscaldata.treasury.gov `auctions_query` `announcemt_date:eq:2026-09-17`, fetched direct by this event's own close-out session 2026-09-18 — the executed auction record carries exactly the seven predicted securities) · **Impact:** medium
**Last assessed:** 2026-09-18
<!-- probe-ref: {"symbols":{},"vix":15.44,"daysBand":"medium:0+","adjacentIds":["boe-decision-2026-09-17","boj-decision-2026-09-18","bowman-stress-testing-2026-09-18","bund-30y-auction-2026-09-16","buyback-blackout-start-2026-09-12","eia-weekly-petroleum-status-2026-09-16","empire-state-mfg-2026-09-15","eurostat-hicp-final-2026-09-17","fomc-2026-09-16","g20-energy-abundance-ministerial-houston-2026-09-14","gastech-2026-09-14","google-adtech-opinion-unseal-2026-09-16","house-vote-ratepayer-protection-act-2026-09-17","housing-starts-2026-09-17","import-export-prices-2026-09-16","industrial-production-2026-09-18","japan-cpi-2026-09-18","jgb-20y-auction-2026-09-15","jpx-market-closure-2026-09-21","jpx-market-closure-2026-09-22","kb-home-q3-fy2026-2026-09-22","lennar-q3-fy2026-2026-09-16","missouri-map-tro-expiry-2026-09-22","missouri-uocava-ballot-mailing-2026-09-19","nahb-hmi-2026-09-16","opex-2026-09-18","pending-home-sales-2026-09-17","philly-fed-mfg-2026-09-17","retail-sales-2026-09-16","russell-quarterly-ipo-review-effective-2026-09-21","sp-global-investment-manager-index-2026-09-15","sp-quarterly-rebalance-effective-2026-09-21","tic-monthly-2026-09-16","treasury-10y-tips-2026-09-17","treasury-20y-bond-2026-09-15","treasury-2y-note-2026-09-22","treasury-buyback-7y10y-2026-09-17","treasury-buyback-tips-10y30y-2026-09-15","uk-cpi-2026-09-16","uk-labour-market-2026-09-15","uk-public-sector-finances-2026-09-22","uk-retail-sales-2026-09-18","unga-81-general-debate-2026-09-22","unsc-iran-panel-mandate-vote-2026-09-17","vix-expiration-2026-09-16"],"adjacentStrongIds":["fomc-2026-09-16","opex-2026-09-18","retail-sales-2026-09-16","treasury-20y-bond-2026-09-15"],"screenStreak":0} -->

## At a glance

**TL;DR.** **D0 — the announcement itself has not posted yet as of this session, and the news since the
last row resolves this doc's own open risk in the hold's favor.** The FOMC delivered the hawkish
25bp hike the 09-10 tape was already pricing (3.75–4.00%, unanimous, "inflation remains elevated," a
majority of the SEP dots see another hike this year) — but leg 12 stands: an auction-size announcement
doesn't touch rates, so this has no channel into what 09-17 publishes, only into what the 09-21/22
bills and 09-22/23/24 coupons subsequently *yield*. The bigger move for this doc is the cash position:
TGA jumped **$843.7B (09-09) → $991.6B (09-15)**, **+$147.9B**, blowing *through* `sb0590`'s **$950B**
end-September assumption with two weeks still to run — the ~$106B shortfall the last row flagged as a
one-sided upward risk to the hold is gone, not merely narrowed. A third straight bill-announcement cycle
(09-15: 4-week held $90B, 8-week held $85B) adds a further hold data point. Treasury's own press-release
stream (`sb0622`→`sb0631`) and the fiscaldata auction record still carry no 09-17 coupon/FRN entry as of
this fetch — expected ~11:00 ET, still ahead. Date is `estimate`, `symbols: []`, nothing here is a trade.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (2026-09-17, D0) | Stand aside | High | `symbols: []`, no house playbook (S1/S2/E1/S3/S4 + G1) is rates-keyed, and every coupon number is already in `sb0590`. The announcement itself (composition + sizes already published in advance) is confirmatory, not actionable. | Treasury publishing an off-cycle **coupon or FRN** size change, or a coupon CMB, before this release — checked this session against the press-release stream `sb0622`→`sb0631`, which carries no issuance action at all |
| This week | Watch **09-15** (6-week auction · 20Y reopening · TIPS buyback) and **09-16** (FOMC); hold nothing through either | High | The 6-week's *size* is settled at $75B, so 09-15 now tests only its yield. The live read is the **09-15** corporate/non-withheld tax date — 09-17 is the first announcement written with those receipts in hand. | The TGA still below **$900B** at the **2026-09-16** DTS close — the receipts did not close the gap to $950B, and the shortfall drives the bill leg instead of the seasonal pattern |
| This month | Expect a **hold** on the bill leg — 13-week **$92B**, 26-week **$79B**, 6-week **$75B** | Medium-high (raised from Medium on 2026-09-10) | Five tenors held flat across the **09-08** and **09-10** announcements with none cut; the 09-10 6-week at $75B resolves this doc's own early falsifier in its favour; benchmarks were unmoved at every mid-September announcement in **2023, 2024 and 2025**. | Either benchmark printing off **$92B / $79B** on **2026-09-17**, or the 6-week printing **above $75B** — the seasonal pattern and the "cut already spent" reading break together |
| This quarter | The deductive coupon channel runs to **2026-11-12**; expect October to **reverse** into bill increases | Medium | `sb0590` verbatim: *"In October, Treasury anticipates increasing auction sizes across the bill curve based on expected seasonal fiscal outflows"*, TGA projected to peak at **$1.05T** in late October — and a TGA now $106B short of its September marker makes that reversal likelier, not less likely. | Treasury dropping or qualifying *"for at least the next several quarters"* at the **2026-11-04** refunding — the scheduled-nil frame is conditional on that sentence, and [`FT-39`](../forward-tests/legacy.md) already measures it |
...
- **Confirmed 2026-09-10 — the 09-10 announcement held all three:** 13-week **$92B** · 26-week **$79B**
  (auction 09-14) · 6-week **$75B** (auction 09-15). The early falsifier did not fire.
- **`sb0590`'s Sep-26 row has now been executed once, observably:** the 09-10 release printed the 20-Year
  reopening at **$13B**, exactly its 20-Year column. The 09-17 coupon half reads off the same row.
- **TGA is draining and the gap widened:** **$843.7B** (09-09 DTS close) vs `sb0590`'s **$950B**
  end-September assumption — **~$106B** short, against ~$46B on 09-03. The 09-15 tax date is the closer.
- **The risk to the hold is now one-sided upward** — a widening cash shortfall argues for *more* bill
  supply, never a deeper cut. An increase on 09-17 is the live fail mode; a further cut is not.
...
- **09-17 is a four-event session, which is why no tape attribution will be attempted:** this
  announcement ~11:00 ET → 10Y TIPS reopening auction 1:00pm → **$4B 7-10Y buyback 1:40pm** → blackout ends.
- **Watch (dated):** ~~announcement 09-10~~ **done, held** · bills + 20Y + TIPS buyback **09-15** ·
  **FOMC 09-16** · 10Y TIPS + buyback + **this announcement 09-17** · triple witching **09-18** · bills
  **09-21/09-22** · 2Y **09-22** · FRN reopening + 5Y **09-23** · 7Y **09-24** · settlement + funding
  deadline **09-30** · refunding **11-04** · first unpublished announcement **11-12**.
...
**Stance amendment 2026-09-10 (D-7) — the call is unchanged; its confidence is not.** The 09-10 ledger
row below is the receipt. The bill-leg hold moves **Medium → Medium-high** on three measurements, not on
a re-reading: the 09-10 announcement set the 6-week at **$75B** (so this doc's own two-days-early
falsifier is resolved in its favour, and the *size* half of that check can no longer change on 09-15);
the 09-08 and 09-10 announcements between them held five tenors flat and cut none, meaning the September
reduction programme had two chances to extend and declined both; and the 20-Year reopening printed at
**$13B**, the first observed execution of an `sb0590` Sep-26 anticipated size. Pushing the other way, and
recorded rather than netted out: the TGA closed **$843.7B** on 09-09, widening the gap to `sb0590`'s
$950B end-September assumption from ~$46B to **~$106B**. That does not argue for a deeper cut — it argues
for an *increase*, so the two-sided risk stated on 09-05 is now **one-sided upward**, which is why the
confidence rises only one notch and not to High. **No new forward test is registered**:
`FT-…-09-17-1` and `FT-…-09-17-2` already carry these predictions, both remain open and scoreable
2026-09-18, and adding a row for a confidence change would double-count the same claim — the same
discipline the paragraph below applies to the coupon sizes.

**Stance amendment 2026-09-17 (D0) — the call is unchanged; the one-sided risk flagged 09-10 is
resolved, not merely reduced.** TGA closed **$991.6B on 09-15** (DTS), up from **$843.7B on 09-09** —
**+$147.9B in four sessions**, the mid-September corporate/non-withheld tax date landing at almost
exactly the magnitude the 2025 analogue implied (+$190B in five sessions). That closes the ~$106B gap
to `sb0590`'s **$950B** end-September assumption and clears it, with the 09-30 settlement date still two
weeks out — so the residual risk the last row called "one-sided upward" (a widening cash shortfall
forcing a bill-size increase) no longer has a shortfall to argue from. A third bill-announcement cycle
(**09-15**: 4-week held **$90B**, 8-week held **$85B**, both unchanged from 09-10/09-08; a new 17-week
line printed at **$72B**) adds a third data point to leg 6's "September reduction already spent"
finding without moving it. Separately, the **09-16 FOMC** delivered the hike the prior row's tape had
already priced (25bp to 3.75–4.00%, unanimous, hawkish SEP) — recorded because it is this corridor's
loudest adjacency-sweep item, not because it touches this release (leg 12: an announcement publishes
sizes, not rates). **This event's own announcement has not been observed yet** — the press-release
stream (`sb0622`→`sb0631`, none an issuance action) and the fiscaldata auction record (most recent
`announcemt_date` on file: 2026-09-15, bills only) show nothing for 09-17 as of this session's fetch,
consistent with the ~11:00 ET publish time not yet having passed. Forward tests `-1` and `-2` are
unscored and remain scoreable 2026-09-18, once the actual release is on the record. VIX **15.95**
(09-17 print) vs **17.6** on the last screen — a ~1.6pt easing, short of the 3-point regime threshold,
and notably not a vol spike despite the hawkish hike.
...
| 2026-09-10 | D-7 | **Pulse check. THE EARLY FALSIFIER DID NOT FIRE.** This doc's own two-days-early check was *the 2026-09-15 6-week bill printing below $75B*. Today's **09-10** announcement (fiscaldata `auctions_query`, `announcemt_date: 2026-09-10`, fetched 09-10) sets it at **$75B** — held — with **13-week $92B** and **26-week $79B** (auction 09-14) unchanged. The *size* half of that check is now settled and cannot move on 09-15; only its yield is still open. **Second confirmation the cut is spent:** the **09-08** announcement held 4-week **$90B** and 8-week **$85B** (auction 09-10) with no further trim. Across the two announcement cycles since the last row, **five tenors held flat and none was cut** — the September reduction programme had two chances to extend and took neither. **First OBSERVED execution of an `sb0590` Sep-26 size:** the same 09-10 release printed the **20-Year reopening at $13B**, matching the Sep-26 row's 20-Year column verbatim (`69 58 70 44 39 13 22 28`), plus the **10-Year TIPS reopening at $19B** (auction 09-17, settle 09-30). Until today every Sep-26 number in this doc was a document read; one of them is now a print. **Both data traps re-confirmed live in one row:** that TIPS files as `security_type: Note` with `security_term: 9-Year 10-Month` — trap (a) and the remaining-term trap together. **TGA — the one thing that got worse.** DTS closing balances 09-03 **$903.9B** → 09-04 $888.9B → 09-08 $880.0B → **09-09 $843.7B**, i.e. **−$60.2B since the last row**, against `sb0590`'s **$950B** end-September assumption: the shortfall widens from ~$46B to **~$106B**. The **09-15** corporate and non-withheld tax date is still the closer (the 2025 analogue, **+$190B in five sessions**, would land ~$1,034B), and Treasury made today's flat decision with the balance already at $843.7B. **The asymmetry is now explicit — a widening cash gap argues for MORE bill supply, never a deeper cut, so the live fail mode for 09-17 is an increase.** **DTS data note:** the "TGA Closing Balance" row carries its value in `open_today_bal` and its `close_today_bal` is null — read the closing series off the obvious field and it looks empty. **Adjacency — macro:** August **PPI** released today, headline final demand **+0.4% m/m** (BLS public API series `WPSFD4`, SA, fetched 09-10, reproduced independently here). **Scored in-line, not hot, by its own ledger** [`ppi-2026-09-10`](ppi-2026-09-10.md), whose pre-registered guard moved the hot line to ≥0.5% once the street settled at +0.4%, with core measures *softer* than street; that scoring is that ledger's and is not re-litigated here. **CPI is tomorrow, 09-11.** **Rates — a hawkish tape on an in-line print.** Treasury par, 09-04 (the last row's baseline) → **09-10**: 3-Mo 3.91 → **4.00** · 2Y 4.37 → **4.56** (+19bp) · 5Y 4.54 → **4.75** (+21bp) · 7Y 4.65 → **4.84** (+19bp) · 10Y 4.78 → **4.95** (+17bp) · 20Y 5.25 → **5.39** · 30Y 5.24 → **5.37**; today alone was **+9 to +14bp across every tenor**. **VIX 14.53 → 17.84 (+3.31)**, past the 3-point regime threshold. **None of it touches what 09-17 announces** (leg 12 — an announcement publishes sizes, not rates); it raises what the 09-22/23/24 coupons will *yield* and the 13-week index rate the FRN reopening resets against, both owned elsewhere. **VIX caveat:** Yahoo carries a 2026-09-07 close of 15.30 on a session `labor-day-market-closure-2026-09-07` says was shut — treated as a vendor artifact and not used; the move is measured close-to-close 09-04 → 09-10. **Adjacency — the corridor tripled, 15 → 36 ids, and the newcomer that matters lands on the day itself.** [`treasury-buyback-7y10y-2026-09-17`](treasury-buyback-7y10y-2026-09-17.md) is a **$4B liquidity-support buyback in 7-10Y nominals, 1:40-2:00pm ET on 09-17**, announced 09-16. So 09-17 now stacks this announcement ~11:00 ET → the 10Y TIPS auction 1:00pm → the buyback 1:40pm, on the final blackout day, one day after FOMC and one before triple witching. **Leg 11 hardens: no intraday attribution to this announcement is defensible, and none will be attempted at close-out.** Also new in-corridor: `treasury-buyback-tips-10y30y-2026-09-15` ($500M), `boe-decision-2026-09-17`, `uk-cpi-2026-09-16`, `bund-30y-auction-2026-09-16`, `jgb-20y-auction-2026-09-15`, six US data prints and two index events on 09-21. **Cadence band transitioned** medium:8+ → **medium:0+** at D-7, interval 7d → 2d. **Kill switches checked against the source, not against silence:** Treasury's press-release stream **`sb0617` → `sb0626`** (fetched 09-10) carries **no issuance or debt-management action** — all sanctions, tax, G20 and portfolio-holdings items — so *an off-cycle coupon or FRN issuance action* has not fired in the five days since the last row. **Geopolitical:** four of those ten releases are Iran sanctions under "Operation Economic Outcast", and `unsc-iran-panel-mandate-vote-2026-09-17` sits on this event's own date; `symbols: []` and an auction-size announcement has no transmission channel — recorded because the corridor is loud, not because it bears. **Source access:** `bls.gov` returned **403** to a browser-headered fetch (the lane's documented blind spot, now recorded in `probe-ref.blocked`), but **`api.bls.gov/publicAPI/v2` returned 200** — the public API is the working route past that block, written down so the next session does not rediscover it. **Adjacency — a chain gap raised and REFUTED in-session.** The calendar tracks `treasury-coupon-announcement-*` on 09-03, 09-10, 09-17, 10-01, 10-15 and 10-22 but not on **09-24** or **10-08**, which looks like a hole in an otherwise dense chain. It is not: the auction record shows the fourth-week announcement is **bills-only** — **2026-08-27** announced 13-week, 26-week, 6-week **and the 52-week** (auction 09-01) with no coupon — and this calendar tracks coupon announcement days, not bill announcement days. So 09-24, where this doc places the 52-week, is correctly untracked. The last row declined a bill-auction proposal on precedent; this row declines the announcement-day one on **verified composition**. **No new dated event proposed. No forward test registered** — `-1` and `-2` already carry these predictions, both open and scoreable 09-18. | **Call unchanged; bill-leg confidence Medium → Medium-high** — the early falsifier resolved in favour, five tenors held across two announcement cycles, and `sb0590`'s Sep-26 row executed once observably. The TGA shortfall widening to ~$106B is why it is not High, and it turns the residual risk **one-sided upward** (an increase, never a deeper cut) | 2026-09-12 (medium; D-7 sits in the 0+/2d band) |
...
| 2026-09-17 | D0 | **Pulse check (staleness-ceiling — 3rd consecutive screen forced a full session).** **THE ANNOUNCEMENT ITSELF IS NOT YET ON THE RECORD.** Treasury's press-release stream (`sb0622`→`sb0631`, fetched this session) carries no issuance action — sanctions, TIC data, a Bessent statement, a Mint commemorative, all not this release — and `api.fiscaldata.treasury.gov` `auctions_query` sorted by `announcemt_date` desc returns **2026-09-15** (bills only: 4-week, 8-week) as its most recent row, nothing for 09-17. Consistent with the ~11:00 ET publish time not yet having passed as of this fetch; not a finding about the release itself. **THE TGA GAP FROM THE LAST ROW IS CLOSED, NOT NARROWED.** DTS closing balance **$991.6B on 09-15** vs **$843.7B on 09-09** — **+$147.9B in four sessions** (09-09 → 09-10 $818.1B → 09-11 $822.2B → 09-14 $871.2B → 09-15 $991.6B), the mid-September tax date landing close to the 2025 analogue's +$190B/5-session magnitude. This **clears** `sb0590`'s **$950B** end-September assumption two weeks early, so the 09-10 row's "one-sided upward" risk to the hold call (a cash shortfall forcing a bill-size increase) no longer has a shortfall to point to. **A third bill-announcement cycle reinforces leg 6 without moving it:** the **09-15** announcement (fiscaldata, fetched this session) held 4-week at **$90B** and 8-week at **$85B**, both unchanged from 09-08/09-10, and opened a new 17-week line at **$72B** — the September reduction stays spent, three cycles running. **Adjacency — macro, the corridor's loudest item, doesn't touch this release:** the **09-16 FOMC** delivered a **25bp hike to 3.75–4.00%**, unanimous 12-0, hawkish SEP (majority see another hike this year), matching the hawkish repricing the 09-10 row's tape already showed — recorded per leg 12 (an auction-size announcement publishes sizes, not rates; this transmits into what the 09-21/22 bills and 09-22/23/24 coupons *yield*, and into the FRN reopening's post-FOMC index timing, both owned elsewhere). **VIX 15.95** (09-17 print, live probe) vs **17.6** on the last screen — a **-1.65pt** ease, short of the 3-point regime threshold, and counter to what a hawkish surprise usually does to vol. **Adjacency — geopolitical/policy, both same-day and both unresolved as of this fetch:** the **UNSC Iran sanctions panel mandate vote** and the **BoE rate decision** are both dated 09-17 in this corridor; pre-vote/pre-decision reporting only, no outcome yet, and neither has a transmission channel into `symbols: []`. **Adjacency — corridor grew 39 → 44 ids, none strong:** new since the last row — `japan-cpi-2026-09-18`, `jpx-market-closure-2026-09-21`, `jpx-market-closure-2026-09-22`, `kb-home-q3-fy2026-2026-09-22`, `lennar-q3-fy2026-2026-09-16` — all already-tracked calendar entries (not new dated discoveries), none confirmed high/critical, `adjacentStrongIds` unchanged (`fomc-2026-09-16`, `opex-2026-09-18`, `retail-sales-2026-09-16`, `treasury-20y-bond-2026-09-15`). **Kill switches checked against sources, none fired:** no off-grid coupon/FRN (nothing published yet to be off-grid), no benchmark bill deviation (13w/26w untouched this cycle), the 6-week's $75B (09-10) stands untested since no session since re-announced it. **No new dated event proposed. No forward test registered** — `-1` and `-2` remain open, scoreable 2026-09-18, pending the actual release. | **Call unchanged (hold, Medium-high); the residual upside risk to the hold is resolved rather than reduced** — the TGA gap the last row flagged is closed, and a third bill cycle plus the FOMC's rates-only channel leave nothing pointing at a size change | 2026-09-18 (event-passed-unscored close-out, held for FT-treasury-coupon-announcement-2026-09-17-1/-2, both scoreable 2026-09-18) |
| 2026-09-18 | D+1 | **Close-out completed.** Cache busted first (`rm -rf node_modules/.cache/earnings-cycle node_modules/.cache/intraday-edges`), though `symbols: []` gives neither instrument a target, unchanged from initial research — "re-run instrument data" here means re-fetching the executed auction record itself, never recalling the prior rows' document reads. **`api.fiscaldata.treasury.gov` `auctions_query` filtered `announcemt_date:eq:2026-09-17`, fetched direct this session (HTTP 200, 7 rows, 34,314 bytes), returns exactly the seven predicted securities:** `13-Week BILL` **$92B** (reopening) auction 09-21 · `26-Week BILL` **$79B** auction 09-21 · `6-Week BILL` **$75B** (reopening) auction 09-22 · `2-Year NOTE` **$69B** auction 09-22 · `2-Year FRN` reopening (`security_term: 1-Year 10-Month`, `floating_rate: Yes`) **$28B** auction 09-23 · `5-Year NOTE` **$70B** auction 09-23 · `7-Year NOTE` **$44B** auction 09-24 — the three notes settling **09-30**, the FRN settling **09-25**. **No 52-week bill in the batch.** **`FT-treasury-coupon-announcement-2026-09-17-1` PASSES** — composition and all four coupon sizes match the prediction exactly, so `FT-treasury-coupon-announcement-2026-10-22-1`'s free out-of-sample pre-check is unkilled. **`FT-treasury-coupon-announcement-2026-09-17-2` PASSES** — 13-week and 26-week unchanged at 92/79, 6-week at exactly $75B (the ceiling, not above it); the September reduction stayed spent through the announcement that tests it, and the 3-of-3 seasonal base rate for flat mid-September benchmarks is now 4-of-4. **Status promoted `estimate` → `confirmed`** in this event's own calendar file (`src/domain/market-events/treasury-coupon-announcement-2026-09-17.json`), source `TSY:`, citing this session's own re-fetch of the executed record — the no-self-confirm limit bound the discovering lane (`treasury-2y-frn-2026-09-23`), not this owner, and TSY: is an authorized confirmed-tier prefix (the same standard `mts-october-2026-11-12` and `tic-annual-survey-final-2027-04-30` used). **Press-release stream checked, not just the auction API:** `sb0625`→`sb0632` (fetched this session) carries a health-care-fraud release, three Operation Economic Outcast sanctions actions, a Mint commemorative, a GloBE statement, a Bessent House testimony statement and July TIC data — no dedicated issuance-action release, confirming (a third time, across three sessions) that this release is PDF/API-only, never press-release-numbered. **VIX 15.44** (Yahoo daily close, 2026-09-17) vs **15.95** the last row's intraday read — the eventual close came in lower than the live D0 probe, still well short of the 3-point regime threshold from either baseline. **No new adjacency proposal** — the adjacency sweep is not mandatory at close-out and nothing dated and new surfaced incidentally. **`## Outcome` written below — this document goes quiet.** | Both forward tests PASSED; the hold call and the composition finding both stand confirmed against the executed record (see `## Outcome`) | — (closed; scanner goes quiet on this event) |
...
**Close-out (2026-09-18, D+1 — inside the `closeOutWithinDays: 6` deadline).** Rates mode carries no
`earnings-cycle` / `intraday-edges` instrument (`symbols: []` by design; the cache-bust command was run
regardless, per the lane's standing instruction — nothing was in it). "Re-run instrument data" here means
the executed auction record itself, re-fetched direct from `api.fiscaldata.treasury.gov` `auctions_query`
(`announcemt_date:eq:2026-09-17`, HTTP 200, 7 rows) — none of it recalled from initial research or the
prior pulses' document reads of `sb0590` and the tentative schedule PDF.

### What printed

| Security | Predicted | Printed | Auction | Settle |
|---|---|---|---|---|
| 13-Week BILL | $92B (hold) | **$92B** | 2026-09-21 | 2026-09-24 |
| 26-Week BILL | $79B (hold) | **$79B** | 2026-09-21 | 2026-09-24 |
| 6-Week BILL | ≤$75B | **$75B** | 2026-09-22 | 2026-09-24 |
| 2-Year NOTE | $69B | **$69B** | 2026-09-22 | 2026-09-30 |
| 2-Year FRN (reopening) | $28B | **$28B** | 2026-09-23 | 2026-09-25 |
| 5-Year NOTE | $70B | **$70B** | 2026-09-23 | 2026-09-30 |
| 7-Year NOTE | $44B | **$44B** | 2026-09-24 | 2026-09-30 |
| 52-Week BILL | not on this release | **absent** | — | — |

Every predicted number printed exactly, and the one predicted absence (the 52-week bill) was absent.
The FRN reopening files as `security_term: 1-Year 10-Month` with `floating_rate: Yes`, `reopening: Yes`
— the remaining-term filing convention the 2026-09-05 initial research named as a data trap, now
observed live rather than inferred from the sibling chain.

### Forward tests, scored

| Test | Prediction | Printed | Verdict |
|---|---|---|---|
| FT-…-1 (seven-security composition, no 52-week) | exact composition + 69/70/44/28, registered 2026-09-05 | matched exactly (table above) | **PASSED** |
| FT-…-2 (bill leg holds against the guidance's plain reading) | 92/79 unchanged, 6-week ≤75 | 92/79/75 | **PASSED** |

**Both tests pass, and the diagnostic one is `-2`.** The composition test (`-1`) confirms Treasury did
what it wrote down — the near-uninformative half this doc disclosed up front. The bill-leg test (`-2`)
is the one this doc built to be genuinely falsifiable: `sb0590`'s own language ("reductions ... during
the month of September") reads like a forecast for this announcement, and the measured finding —
verified independently at initial research (09-05), reinforced at the 09-10 pulse and again at the
09-15 screen and 09-17 pulse — was that the reduction had already been executed by 09-08, nine days
early. The 6-week printing at exactly $75B, the level set on 09-10 and never moved since, is the
executed-not-forecast reading confirmed on contact with the actual release. The seasonal base rate this
finding rested on (n=3: 2023/2024/2025, benchmarks flat through every mid-September announcement) is
now n=4.

**Status promoted `estimate` → `confirmed`** on this session's own re-fetch of the executed record
(`TSY:` prefix, `src/domain/market-events/treasury-coupon-announcement-2026-09-17.json`) — the
no-self-confirm limit bound the discovering lane, not this owner. `FT-treasury-coupon-announcement-2026-10-22-1`,
which named this release its "free out-of-sample pre-check," is unkilled by the same record.

**No claim beyond the two registered tests.** `symbols: []`, no house playbook is rates-keyed, and
nothing here was or should be traded — the honest content of this close-out is that a scheduled-nil
announcement, and the one genuinely contested number inside it, both resolved exactly as the
2026-09-05 initial research derived from public Treasury guidance and the executed bill-issuance
record, without needing the announcement's own text to arrive first.

`## Outcome` now exists — per `event-scan.mjs`'s `hasOutcome` check, this document goes quiet
permanently.
