...
<!-- probe-ref: {"symbols":{},"vix":17.84,"daysBand":"medium:0+","adjacentIds":["boe-decision-2026-09-17","boj-decision-2026-09-18","bund-30y-auction-2026-09-16","buyback-blackout-start-2026-09-12","empire-state-mfg-2026-09-15","eurostat-hicp-final-2026-09-17","fomc-2026-09-16","g20-energy-abundance-ministerial-houston-2026-09-14","gastech-2026-09-14","google-adtech-opinion-unseal-2026-09-16","housing-starts-2026-09-17","import-export-prices-2026-09-16","industrial-production-2026-09-18","jgb-20y-auction-2026-09-15","missouri-map-tro-expiry-2026-09-22","missouri-uocava-ballot-mailing-2026-09-19","nahb-hmi-2026-09-16","opex-2026-09-18","pending-home-sales-2026-09-17","philly-fed-mfg-2026-09-17","retail-sales-2026-09-16","russell-quarterly-ipo-review-effective-2026-09-21","sp-global-investment-manager-index-2026-09-15","sp-quarterly-rebalance-effective-2026-09-21","tic-monthly-2026-09-16","treasury-10y-tips-2026-09-17","treasury-20y-bond-2026-09-15","treasury-2y-note-2026-09-22","treasury-buyback-7y10y-2026-09-17","treasury-buyback-tips-10y30y-2026-09-15","uk-cpi-2026-09-16","uk-labour-market-2026-09-15","uk-public-sector-finances-2026-09-22","unga-81-general-debate-2026-09-22","unsc-iran-panel-mandate-vote-2026-09-17","vix-expiration-2026-09-16"],"screenStreak":0,"blocked":[{"url":"https://www.bls.gov/schedule/news_release/cpi.htm","status":403,"at":"2026-09-10"}]} -->

## At a glance

**TL;DR.** **The free read came back, and it came back on the call.** This doc's own two-days-early
falsifier was *the 09-15 6-week bill printing below $75B*; today's **2026-09-10** announcement set that
auction at **$75B** — held, not cut — alongside 13-week **$92B** and 26-week **$79B**, both unchanged.
Treasury has now had two announcement cycles since the last row (**09-08** and **09-10**) to extend the
September reduction and took neither, so the "the cut is already spent" premise survived its first real
test. The same release printed the 20-Year reopening at **$13B** — `sb0590`'s Sep-26 row executed
verbatim, the first *observed* evidence that the row this doc reads the coupon sizes off is being
followed. **The bill-leg hold call goes Medium → Medium-high.** One thing got worse: the cash position.
TGA closed **$843.7B** on 09-09 against `sb0590`'s **$950B** end-September assumption — a **~$106B** gap
where the last row measured ~$46B — so the surviving risk to a hold is an **increase**, not a further
cut. Date is `estimate`, `symbols: []`, nothing here is a trade.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (2026-09-10, D-7) | Stand aside | High | `symbols: []`, no house playbook (S1/S2/E1/S3/S4 + G1) is rates-keyed, and every coupon number is already in `sb0590`. Today's news is confirmatory, not actionable — a size held is not a signal. | Treasury publishing an off-cycle **coupon or FRN** size change, or a coupon CMB, before **2026-09-17** — checked today against the press-release stream `sb0617`→`sb0626`, which carries no issuance action at all |
