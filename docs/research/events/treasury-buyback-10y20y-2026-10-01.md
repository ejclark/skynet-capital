...
**Kind:** rates · **Date:** 2026-10-01 (estimate, EST: treasury.gov Tentative Schedule of Treasury Buyback Operations — the **updated** schedule `sb0607` promised, masthead "For Publication September 9, 2026", PDF text-layer decompressed direct 2026-09-15, HTTP 200, 89,250 bytes, md5 c49a5351bf2d31a367817abc62be51bd; row reads announce 9/30, operation 10/1 1:40–2:00pm ET, settle 10/2, Nominal Coupons 10Y to 20Y, 10/02/2036–10/01/2046, min $0, max **"= or > $4 billion"** — no longer a number) · **Impact:** medium
**Last assessed:** 2026-09-15
<!-- probe-ref: {"symbols":{},"vix":17.56,"daysBand":"medium:8+","adjacentIds":["adp-employment-2026-09-30","advance-economic-indicators-2026-09-30","apple-eu-dma-terms-2026-10-01","bloomberg-agg-index-rebalance-2026-09-30","boe-dmp-2026-10-02","boj-summary-of-opinions-2026-10-01","boj-tankan-2026-10-01","case-shiller-hpi-2026-09-29","census-benchmark-revision-nsa-2026-09-28","chicago-pmi-2026-09-30","construction-spending-2026-10-01","consumer-confidence-2026-09-29","crwv-fully-connected-2026-09-29","dallas-fed-mfg-2026-09-28","dallas-fed-trimmed-mean-2026-09-30","eia-steo-2026-10-06","eurostat-hicp-flash-2026-10-01","fhfa-hpi-2026-09-29","g20-trade-ministerial-milwaukee-2026-09-30","gdp-q2-2026-third-2026-09-30","google-adtech-final-judgment-2026-10-02","government-funding-deadline-2026-09-30","intl-trade-full-report-2026-10-06","ism-manufacturing-2026-10-01","ism-services-2026-10-05","jgb-2y-auction-2026-09-30","jgb-40y-auction-2026-09-29","jobs-2026-10-02","jolts-2026-09-29","m3-full-report-2026-10-02","mrvl-investor-day-2026-10-06","opec-jmmc-68th-2026-10-04","opec-plus-meeting-2026-10-04","pce-2026-09-30","pjm-reliability-backstop-procurement-2026-09-30","retail-benchmark-revision-2026-09-28","russell-style-quarter-end-capping-effective-2026-09-30","sp-global-manufacturing-pmi-2026-10-01","sp-global-pmi-commodity-price-supply-2026-10-01","sp-global-services-pmi-2026-10-05","sp-select-sector-secondary-reweight-2026-09-30","tic-quarterly-external-debt-2026-09-30","treasury-3y-note-2026-10-06","treasury-buyback-2y3y-2026-10-06","treasury-buyback-tips-1y10y-2026-09-29","treasury-coupon-announcement-2026-10-01","uk-electricity-vat-zero-rate-2026-10-01","uk-quarterly-national-accounts-2026-09-30","unsc-iran-panel-mandate-expiry-2026-09-26"],"adjacentStrongIds":["ism-manufacturing-2026-10-01","ism-services-2026-10-05","jobs-2026-10-02","pce-2026-09-30"],"screenStreak":0} -->

## At a glance

**TL;DR.** *(Rewritten 2026-09-15 at D-16 — the header below it is unchanged and the ledger row is
the receipt.)* Still **a read, not a trade**. But the two things this ledger was waiting on both
landed, and between them they **retire its central number**. `sb0607`'s promised updated schedule
**published 2026-09-09** (md5 `c49a5351…`, 89,250 bytes — a different document from the
125,547-byte August-5 one every prior assessment read), and it does what none of the analysis
anticipated: **the long end's maximum is no longer a number.** Every 10-20Y and 20-30Y row from
09-24 through 11-04 now reads **"= or > $4 billion"**, while every other sector keeps a printed
figure. Then the first operation under that regime ran: **2026-09-10 announced $6B** — 50% above
`sb0607`'s floor — drew **$10.489B** (cover **1.75x**) and accepted **$5.187B: 86.4%, the 10-20Y
sector's first non-full fill in 26 operations**, spread across **23 of 40** eligible issues against
1–5 in every prior 2026 operation. So **the $14.0B threshold is withdrawn** — it was arithmetic on
a $4B cap that never printed and can no longer be computed in advance at all.
[`FT-…-1`](../forward-tests/treasury-buyback-10y20y-2026-10-01.md) scores **void** on its own
pre-registered clause (announced max ≠ $4B), **not pass**. The cover *direction* held (sub-2.5x →
partial: now **0 of 24** at a $4B+ cap); the *magnitude* was badly wrong — 86.4% against a **35%**
median in that zone — and **this doc's own perverse case is dead**: the enlarged cap bought
**$5.187B where the superseded $2B cap delivered $2.00B**. Date and maximum stay `estimate`;
`symbols: []`.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (2026-09-15, D-16) | Stand aside | High | `symbols: []`, no house playbook is macro-keyed, and nothing about 10-01 has happened — its maximum is not published and its announcement is 15 days out. **FOMC 09-16 owns the long end this week**, not a 1:40pm plumbing operation. | The **2026-09-24** 20-30Y operation announcing a maximum **below $4B**, or Treasury publishing a long-end maximum in advance again — either would mean the 09-09 schedule's open-ended row was a drafting artifact, not a policy change |
| This week | Read the **2026-09-24** 20-30Y announcement as the next free test — it is the first long-end maximum announced since 09-10 set the only precedent under the unpublished-cap regime | High | It costs nothing and it answers the one question 10-01 turns on: **is $6B the new normal or was it a 09-10 one-off?** The schedule gives only the $4B floor, so every cover figure for 10-01 is uncomputable until a maximum prints. | **09-24 announcing exactly $4.0B and filling 100%** — the long end reverts to mechanical full takes at its floor, 09-10's partial was the anomaly, and this doc's amended base case is wrong on both legs |
| This month | Expect **2026-10-01 to accept LESS than its announced maximum** — a partial take is now the base case, reversing this doc's own 09-06 call; hold nothing through it either way | Medium | Base case: maximum **$6B** (range $4–8B, unknowable until 09-30 11:00 ET), offers **$8–13B** after two consecutive sub-$12B totals → cover **~1.3–2.2x**, in the zone where **0 of 24** operations at a $4B+ cap have ever filled. Medium not high because the maximum is unpublished and one precedent is not a base rate. | **2026-10-01 accepting the full announced maximum** — the sector's 25-of-25 mechanical record reasserts at any cap and 09-10's 86.4% was the outlier, not the regime |
| This quarter | Stand aside on the programme as a yield driver — **reinforced, not merely repeated** | Medium | The long end sold off **through** the first enlarged operation: 10Y **4.784 → 5.010** (+22.6bp) and 30Y **5.246 → 5.383** (+13.7bp) between 09-04 and 09-15. Deficits and the Fed path drive the long end, not $5B a fortnight. **11-04** is where sizing past this quarter is decided. | The **11-04** refunding statement making the enlarged, open-ended long-end size permanent **and** long-end yields easing durably across 10-01 / 10-15 / 11-04 with no macro explanation |

**Signals & conditions** — the buy/sell/hold triggers:

- **Never a position keyed to this operation**, and never an attribution of 10-01's tape to it. `symbols: []`, date and maximum `estimate`, no house playbook (S1/S2/E1/S3/S4 + G1) is macro-keyed.
- **The number to read changed.** Not $14.0B of offers — **cover against the announced maximum**, and that maximum is **no longer published in advance** in this sector. Record it *with* every offer total or cover is not comparable operation to operation.
- **Sub-2.5x cover still means a partial take — 0 of 24 at a $4B+ cap.** What it does *not* mean is a small one: 09-10 filled **86.4%** against a **35%** median in that zone, the highest fill ever recorded below 2.5x cover.
- **The perverse case is dead, and the kill switch that chased it fired without its consequence.** "A second consecutive sub-$12B offer total" **triggered** ($7.40B → $10.49B), yet Treasury bought **$5.187B — 2.6x** the $2.00B the superseded cap delivered mechanically.
- **A thin buyback queue reads dealer inventory, not Treasury demand** — routed here by the [09-10 close-out](treasury-buyback-10y20y-2026-09-10.md), whose own tape showed offers at a 2026-low cover the same afternoon a $22B 30Y reopening drew the year's best bid.
- **Nothing new is proposable from the 09-09 schedule.** All twelve of its rows (09-15 · 09-17 · 09-24 · 09-29 · **10-01** · 10-06 · 10-08 · 10-15 · 10-21 · 10-27 · 11-04 · 11-05) are already tracked calendar entries, as is `treasury-refunding-2026-11-04`.
- **Eligible issues printed 40 on 09-10**, against the **39** this doc inherited from the 10-15 sibling's `FT-…-1`. Recorded here; that test is the 10-15 lane's to score, not this one's.
- **Tape:** VIX **17.56** (09-15) vs **14.53** at the last row — **+3.03**, past the regime threshold. 10Y **5.010** · 30Y **5.383**, both month highs. **FOMC is 09-16.**
- **Watch (dated):** FOMC **09-16** · 7-10Y buyback **09-17** · 20-30Y **09-24** · PCE **09-30** · this operation's announcement **09-30 11:00 ET** · this operation + ISM manufacturing + coupon announcement **10-01** · payrolls **10-02** · 10-20Y **10-15** · FOMC **10-28** · refunding **11-04**, where `sb0607` expires.
...
**Amendment — 2026-09-15 (D-16), receipt: the ledger row of the same date.** Everything above this
line is the 2026-09-06 stance as written and is left intact. Three things changed it.

**(a) The $14.0B threshold is withdrawn, and no dollar threshold replaces it.** It was cover 3.5x
arithmetic on a **$4B** cap. The 2026-09-09 updated schedule prints **"= or > $4 billion"** on every
long-end row through 11-04, and the one operation run under that regime announced **$6B**. A dollar
threshold cannot be computed before an announcement that no longer names a number. The surviving
claim is the ratio: **cover below 2.5x against whatever maximum prints → a partial take**, now **0 of
24** at a $4B+ cap.

**(b) The base case flips from full take to partial take.** The 09-06 stance read *"Treasury
therefore accepts the full announced maximum."* On the sector's only observation at an enlarged cap
Treasury did not: **$5.187B of $6.000B, 86.4%** — the first non-full fill in 26 10-20Y operations.
With two consecutive sub-$12B offer totals behind it, 10-01 is expected to land at cover ~1.3–2.2x
and take **less than its announced maximum**.

**(c) The perverse case — "a bigger cap can buy less" — is refuted on its first observation, and it
was this doc's sharpest original claim.** Leg 7 computed ~$1.6B bought at a thin book. Treasury
bought **$5.187B**, **2.6x** the $2.00B the superseded $2B cap delivered mechanically. The error was
transferring a *cross-sector* fill median (35% below 2.5x cover) into the long end, where 09-10
filled 86.4% by spreading across **23 of 40** eligible issues instead of the 1–5 every prior 2026
operation in this bucket touched. **The cover model predicts the binary well and the magnitude
badly**, and the magnitude is the part that matters for how much paper actually gets bought.

**What `FT-…-1` scored, stated without credit-taking.** **Void**, on its own pre-registered clause —
*"Void (not killed) if … the announced maximum is not $4B"* — because it printed $6B. Its direction
was right (sub-2.5x cover → partial) and that is recorded in the ledger row, but a void row earns no
pass and the rule is not edited after the fact. **`FT-…-2` is on track to void for the same reason**
and is left `_open_`; its score-by is 2026-10-02 and it is not scoreable today. Two successors are
registered below, stated in **cover** terms so they survive whatever maximum prints on 09-30.

**Two forward tests registered this session** in
[`forward-tests/treasury-buyback-10y20y-2026-10-01.md`](../forward-tests/treasury-buyback-10y20y-2026-10-01.md):
**`FT-…-3`** (the regime: 10-01 takes less than its announced maximum at sub-2.5x cover) and
**`FT-…-4`** (the magnitude: it nonetheless buys ≥$3.0B, i.e. the perverse case stays dead). Both
score **2026-10-02**.

**Kill switches — adjudicated 2026-09-15.** Two fired. **"A second consecutive sub-$12B offer
total"** fired ($7.40B on 08-11, $10.49B on 09-10) but **its stated consequence did not obtain** —
the doubled cap did not operate in its perverse zone. **"Treasury … publishing the promised updated
schedule"** fired on 09-09; its instruction was to propose the escalation as its own dated calendar
entry, and that was **checked and found already satisfied** — every row of the new schedule is
tracked, as is the 11-04 refunding. **"The 09-09 or 09-30 announcement printing a maximum below
$4B"** did **not** fire: $6B, 50% above the floor. The two $14.0B-keyed switches are **retired with
the threshold** (offers were $10.49B, neither branch reachable). **"Offers reverting to $15–36B while
long-end yields keep making highs"** is half-live: offers did not revert, but yields did make highs.
The list below is superseded by this paragraph where the two conflict.

**Kill switches (2026-09-06, as originally written):**
...
| 2026-09-15 | D-16 | **Both awaited items landed and together they retire this doc's central number.** **(1) `sb0607`'s promised updated schedule PUBLISHED 2026-09-09** — PDF re-fetched direct today, HTTP 200, **89,250 bytes, md5 `c49a5351bf2d31a367817abc62be51bd`**, masthead "For Publication September 9, 2026", a *different document* from the 125,547-byte / md5 `79b65955…` August-5 one every prior row read. **The long end's maximum is no longer a number:** 09-24, **10-01**, 10-08, 10-15, 10-27 and 11-04 all read **"= or > $4 billion"**, while 7-10Y (09-17) and 2-3Y (10-06) keep **$4B**, 1Mo-2Y (11-05) **$4B** and TIPS **$500M**/**$750M**. This event's row verbatim: announce 9/30 · operation 10/1 1:40–2:00pm · settle 10/2 · 10Y-20Y · 10/02/2036–10/01/2046 · min $0 · max "= or > $4 billion". Entry amended accordingly; the SUPERSEDED-$2B warning is retired because that number is gone from the primary. **(2) The 2026-09-10 operation ran** (`fiscaldata` `buybacks_operations`, **222 rows**, pulled direct, HTTP 200): announced max **$6.000B** — the **first $6B liquidity-support operation ever**, 50% above `sb0607`'s floor, and only the second above $4B in the series' history (2024-10-10, $4.963B) — offered **$10.489B** (cover **1.75x**), accepted **$5.187B = 86.4%**, **the 10-20Y sector's FIRST non-full fill in 26 operations**, spread across **23 of 40 eligible issues** against **1–5** in every prior 2026 operation in this bucket. **`FT-…-1` scored VOID**, on its own pre-registered clause (*"Void … if the announced maximum is not $4B"*) — **not pass**, no credit taken. What the observation says anyway: the cover **direction** held (sub-2.5x → partial; now **0 of 24** full takes at a $4B+ cap, median fill **35%**), the **magnitude** did not — 86.4% is the **highest fill ever recorded below 2.5x cover** (prior max 85%). **`FT-…-2` left `_open_`** (score-by 10-02, not scoreable today) and flagged on track to void for the same reason. **Two successors registered, stated in cover terms rather than dollars: `FT-…-3`** (10-01 accepts less than its announced maximum at sub-2.5x cover) and **`FT-…-4`** (it nonetheless buys ≥$3.0B), both scoring **2026-10-02**. **Leg 7's perverse case REFUTED on first observation** — it computed ~$1.6B at a thin book; Treasury bought **$5.187B**, **2.6x** the $2.00B the $2B cap delivered mechanically. Root cause: a cross-sector fill median transferred into a long end that spreads its buying. **Kill switches adjudicated:** *second consecutive sub-$12B offer total* **FIRED** ($7.40B → $10.49B) **but its stated consequence did not obtain**; *publishing the promised updated schedule* **FIRED**, and its instruction to propose the escalation as a dated entry was **checked and already satisfied** — all twelve rows of the new schedule are tracked, as is `treasury-refunding-2026-11-04`; *maximum below $4B* did **not** fire; the two $14.0B-keyed switches **retired with the threshold**. **Adjacency — peers:** n/a (`symbols: []`). **Macro since the last row:** PPI 09-10 (benign core, hawkish reprice), **CPI 09-11** (+0.40% m/m headline, core +0.29% m/m / +2.45% y/y — moved the 10Y ~1bp), ECB 09-10, 30Y reopening 09-10 (year's best bid), 20Y bond today; **FOMC 09-16 tomorrow**. **Rates:** 10Y **5.010** (+22.6bp vs 4.784 on 09-04) · 30Y **5.383** (+13.7bp vs 5.246) — **the long end sold off THROUGH the first enlarged operation**, hardening leg 13's ~1bp finding. **Volatility:** VIX **17.56** vs **14.53**, **+3.03** — past the 3-point regime threshold; month range 14.32–17.84. **Geopolitical:** nothing new touching this channel. **Eligible count printed 40** on 09-10 vs the **39** inherited from the 10-15 sibling's `FT-…-1` — recorded; that lane scores it. **NOTHING new proposed** — the new schedule's rows are all already tracked. | **Base case FLIPS: full take → partial take**, and the **$14.0B threshold is withdrawn** with no dollar threshold replacing it (the maximum is no longer published in advance). Stance itself unchanged: read, not trade | 2026-09-22 (medium; D-16 sits in the 8+/7d band) |
| 2026-09-22 | D-9 | **No new print in this event's own sector; the cross-sector cover rule gets a third confirmation instead, and the tape reverses rather than extends its pre-FOMC selloff.** **Buyback prints since 09-10** (`fiscaldata` `buybacks_operations`, pulled direct, HTTP 200): **09-15 TIPS 10Y-30Y** offered $2.088B, accepted **$500M = full cap** (cover **4.176x**, ≥3.5x bucket, consistent). **09-17 7Y-10Y nominal** offered $9.74B against a **$4B** cap, accepted **$2.385B = 24.5%** — cover **2.435x**, a **PARTIAL** take, extending the cross-sector "<2.5x cover → never a full take at $4B+" record to **0 of 25** (structurally thin sector, 10 eligible issues, leg 8's caveat — not this doc's own sector, and not this event's own $14.0B-successor tests, which score 2026-10-02). **This event's own sector (10Y-20Y) has produced no new print since 09-10**; the next informative one is **20-30Y on 09-24**, still 2 days out. **Schedule PDF re-fetched** — byte-identical, **89,250 bytes, md5 `c49a5351bf2d31a367817abc62be51bd`**, unrevised since 09-09, still reads **"= or > $4 billion"** for the 10-01 row, announcement still pending (09-30 11:00 ET). **FOMC 09-16**: hiked 25bp to **3.75-4.00%**, first hike since 2023 (press-sourced across several outlets — advisorperspectives, Fox Business, Schwab, babypips — not primary-verified, and the outlets' own dot-plot figures don't fully reconcile with each other, so held loosely); hawkish framing, but the long end **did not** continue making highs through it: **10Y 4.963** (-4.7bp vs 5.010 on 09-15), **30Y 5.296** (-8.7bp vs 5.383), **VIX 14.87** (-2.69 vs 17.56, back toward the month's calm range, below the 3-point regime threshold) — reverses rather than extends the selloff the last row flagged. **Adjacency — peers:** n/a (`symbols: []`). **Adjacency — corridor:** 59 tracked entries now sit within ±5 days of 10-01 (up from 25 named on 09-15, grown by other lanes' sweeps, not this one's discovery), but the **confirmed high/critical set is unchanged** — still exactly `ism-manufacturing-2026-10-01`, `pce-2026-09-30`, `jobs-2026-10-02`, `ism-services-2026-10-05`; no new confirmed high/critical adjacent event. **NOTHING new proposed** — every dated entry found (`openai-devday-2026-09-29`, several UNSC/JGB/EIA/PMMS additions) is already a tracked calendar entry, all low/medium impact, none rates-relevant enough to touch this stance. **CR/shutdown:** unchanged, funded through 12-11. **Geopolitical:** nothing new touching this channel. | — (no change; base case, kill switches and the four registered forward tests all stand. The 09-17 cross-sector print reinforces the cover<2.5x rule `FT-…-3`/`FT-…-4` rest on rather than revising it) | 2026-09-29 (medium; D-9 sits in the 8+/7d band) |
