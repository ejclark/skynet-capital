...
| 2026-09-24 | D-14 | **Pulse check, on schedule — both live kill switches re-verified directly today, neither fired.** **Kill switch (restatement notice):** re-fetched `census.gov/wholesale/index.html` — the Intention to Revise notice is unchanged, still "tentatively scheduled for release on October 26, 2026 at 10:00 a.m. EDT" against the 2023/2024 AIES. The 18-day shelf-life frame stands. **Kill switch (reference month deleted):** re-fetched `economic-indicators/calendar-listview.html` — the row is unchanged and normal, "Monthly Wholesale Trade: Sales and Inventories \| October 8, 2026 \| 10:00 AM \| August 2026", `A202610081000`; no `Suspended` marker on this series anywhere between September and November 2026, and the next row after this one is the untouched December 9, 2026 edition (October data). 84/84 still holds. **Macro-keyed playbook check:** re-grepped `docs/plans/trade-playbooks.md` for wholesale/macro/inventory — zero hits, same as the initial session; the stand-aside's absence-of-instrument leg is unchanged. **The two remaining kill switches (GDPNow vintage move, 09-30 advance report omitting wholesale) cannot be checked yet — both postdate today**, the advance report six days out and the print itself two weeks out. **Macro surprises since the last row:** the FOMC hiked 25bp to 2.50% on 2026-09-10, as priced (cross-read off the `ecb-account-2026-10-08` sibling's own close-out cite) — a rate move, not a wholesale-channel surprise; no CPI or jobs print has landed since 09-06. **Volatility regime:** VIX **15.18** (2026-09-23 close, Yahoo daily bar — cross-checked byte-for-byte against today's `construction-spending-2026-10-01` sibling pulse, which independently re-fetched the same bar) against the **14.32** baseline in the last row — a **+0.86pt** move, inside the 3-point screen threshold. **Adjacency sweep — peers:** n/a, `symbols: []`. **Corridor membership, re-swept `--on-date` across 10-03 → 10-13 (the full 5-day-each-side window):** unchanged in substance from the initial read; the one promotion is **`ism-services-2026-10-05`**, now `confirmed`/`high` (was `estimate` at initial research) and therefore the corridor's first `adjacentStrongIds` entry. `mrvl-investor-day-2026-10-06`, `fomc-minutes-2026-10-07`, `sifma-bond-market-closure-2026-10-12`, `consumer-credit-2026-10-07` and `existing-home-sales-2026-10-13` are all `confirmed` but `low`/`medium`, below the strong-adjacency bar. **Geopolitical:** PL 119-103 funding through 2026-12-11 remains the corridor's dominant policy fact; no new item touching this print's non-existent symbol set. **Event tape:** no August consensus exists yet, none expected before the 09-30 advance report. **No new dated adjacent event discovered** — every entry returned across the full re-swept window is already tracked (`opec-jmmc-68th-2026-10-04`, `opec-plus-meeting-2026-10-04`, `sp-global-services-pmi-2026-10-05`, `amzn-prime-big-deal-days-2026-10-06`, `eia-steo-2026-10-06`, `intl-trade-full-report-2026-10-06`, `jgb-10y-auction-2026-10-06`, `treasury-3y-note-2026-10-06`, `treasury-buyback-2y3y-2026-10-06`, `treasury-10y-note-2026-10-07`, `ecb-account-2026-10-08`, `jgb-30y-auction-2026-10-08`, `treasury-30y-bond-2026-10-08`, `treasury-buyback-20y30y-2026-10-08`, `sudan-sanctions-regime-expiry-2026-10-09`, `imf-world-bank-annual-meetings-2026-10-12`, `pjm-iras-ferc-deadline-2026-10-12`, `sp-global-investment-manager-index-2026-10-13`); no proposal filed this pulse. No forward test scoreable yet — all three score on or after 2026-10-08, still ahead. `probe-ref.blocked` empty this pulse. | **No change.** Stand aside holds on every horizon; both checkable kill switches re-verified negative, the VIX move is well inside the regime threshold, and the one corridor promotion (`ism-services-2026-10-05` to confirmed/high) does not touch a series with no symbols and no instrument. | 2026-10-01 (low:0+ band, 7d interval — D-14 is inside the 15-day cutoff) |
...
<!-- probe-ref: {"symbols":{},"vix":15.18,"daysBand":"low:0+","adjacentIds":["opec-jmmc-68th-2026-10-04","opec-plus-meeting-2026-10-04","ism-services-2026-10-05","sp-global-services-pmi-2026-10-05","amzn-prime-big-deal-days-2026-10-06","eia-steo-2026-10-06","intl-trade-full-report-2026-10-06","jgb-10y-auction-2026-10-06","mrvl-investor-day-2026-10-06","treasury-3y-note-2026-10-06","treasury-buyback-2y3y-2026-10-06","consumer-credit-2026-10-07","fomc-minutes-2026-10-07","treasury-10y-note-2026-10-07","ecb-account-2026-10-08","jgb-30y-auction-2026-10-08","treasury-30y-bond-2026-10-08","treasury-buyback-20y30y-2026-10-08","sudan-sanctions-regime-expiry-2026-10-09","imf-world-bank-annual-meetings-2026-10-12","pjm-iras-ferc-deadline-2026-10-12","sifma-bond-market-closure-2026-10-12","existing-home-sales-2026-10-13","sp-global-investment-manager-index-2026-10-13"],"adjacentStrongIds":["ism-services-2026-10-05"],"screenStreak":0,"blocked":[]} -->
