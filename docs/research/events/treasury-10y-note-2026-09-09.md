...
<!-- probe-ref: {"symbols":{},"vix":14.53,"daysBand":"high:0+","adjacentIds":["aapl-iphone-18-launch-2026-09-09","buyback-blackout-start-2026-09-12","cpi-2026-09-11","eia-steo-2026-09-09","fomc-blackout-start-2026-09-05","g20-energy-abundance-ministerial-houston-2026-09-14","gastech-2026-09-14","jobs-2026-09-04","mts-august-2026-09-11","opec-plus-meeting-2026-09-06","ppi-2026-09-10","sp-rebalance-proforma-2026-09-04","sp-rebalance-proforma-capped-2026-09-11","treasury-30y-bond-2026-09-10","treasury-3y-note-2026-09-08","treasury-buyback-10y20y-2026-09-10","treasury-buyback-increase-2026-09-09","umich-sentiment-prelim-2026-09-11"],"screenStreak":0} -->
...
|---|---|---|---|---|
| Today (9/5) | Stand aside | High | Weekend; nothing prices until Monday. The auction side is settled ($39B run-rate, re-verified) and the two things that moved are both *cautionary* re-reads of prior rows, not new tradable information. Nothing here is symbol-keyed or directional. | Nothing today; the next hard input is the 3Y auction result on **2026-09-08** |
| This week | Watch oil and the 9/8 3Y, not the Fed — no Fed voice is legal from 9/5 | Medium | Blackout is **in effect**, so hike odds (**52.6%**) are frozen until PPI/CPI move them; the live variables are Brent ~$95 into a Hormuz shock whose supply-loss component now looks larger than D5 scored it, OPEC+ on **9/6** (weighing a Q4 pause), and the 3Y as the block's first demand read. | Brent falling back under ~$85 on a de-escalation, removing the inflation-uncertainty leg for the third time in this doc |
| This month | Flat the print for high-duration names | High | 9/8→9/9→9/10→9/11 (3Y · 10Y+buyback start · 30Y+10–20Y buyback op · CPI+MTS) is a four-day compound-risk corridor into a coin-flip FOMC; CRWV/NVDA/AVGO/MRVL sized as if both tails are live through it. | A weak print — bid-to-cover materially below ~2.47, a positive tail, or indirects below trend — on **2026-09-09** |
| This quarter | Two live channels now — Fed path and oil; the supply leg is closed | Medium | Supply is settled at run-rate, so what is left is the Fed path (Sep-16, hike **52.6%**, contested, and now frozen by blackout until CPI) and an Iran/Hormuz shock whose realised-supply component looks larger than D5 credited, keeping the inflation-uncertainty leg in through the 9/11 CPI. Term premium persists (10Y 4.78%, 30Y 5.24%, both primary at the 9/4 close) but no longer has a fresh supply catalyst. | A strong print (bid-to-cover ≥2.53, negative tail, indirects near/above 76%) on **2026-09-09** confirming demand is intact |
...
- **Fed silence** (added 9/4, ~~in effect 9/5~~) — blackout is **live**, so hike odds (**52.6%**,
  contested) cannot be moved by a Fed voice before the auction. Between now and 1:00pm ET on 9/9 the
  only things that can reprice this event are **oil**, the **9/8 3Y result**, and positioning.
...
- **Name-level decoupling** (added 9/5) — on 9/4 the 10Y rose on a hot jobs print and the S&P fell
  ...
  name-level moves through 9/11 as sector flow first, auction/rate tell second.
- **Watch (dated)** — ~~coupon-block size announcement Sep 3~~ · ~~jobs Sep 4~~ · ~~Fed blackout
  begins Sep 5~~ · OPEC+ **Sep 6** · 3Y note **Sep 8** · buyback increase effective **Sep 9**
  (auction day, ≥$4B/op, 10–30Y) · EIA STEO **Sep 9** · 30Y reopening + 10–20Y buyback operation
  **Sep 10** · **CPI + Monthly Treasury Statement Sep 11** · G20 energy ministerial + Gastech
  **Sep 14** · 20Y reopening + **FOMC Sep 15–16** · 10Y TIPS **Sep 17** · quarterly OpEx **Sep 18**.
