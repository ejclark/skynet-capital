...
into the belly, or a hot 9/11 CPI forcing a concession the day after. Auction **date is confirmed**;
...
- **Watch (dated)** — 30Y reopening **Sep 10** · **CPI Sep 11** · jobs **Sep 4** (before) · 20Y
