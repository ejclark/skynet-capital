...
<!-- probe-ref: {"symbols":{},"vix":14.05,"daysBand":"high:0+","adjacentIds":["aapl-iphone-18-launch-2026-09-09","cpi-2026-09-11","eia-steo-2026-09-09","fomc-blackout-start-2026-09-05","g20-energy-abundance-ministerial-houston-2026-09-14","gastech-2026-09-14","jobs-2026-09-04","mts-august-2026-09-11","opec-plus-meeting-2026-09-06","ppi-2026-09-10","sp-rebalance-proforma-2026-09-04","treasury-30y-bond-2026-09-10","treasury-3y-note-2026-09-08","treasury-buyback-10y20y-2026-09-10","treasury-buyback-increase-2026-09-09","umich-sentiment-prelim-2026-09-11"],"screenStreak":0} -->
...
guard-shaped — the base case is simply better evidenced than it has ever been.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (9/4) | Stand aside | High | The one number this doc waited five rows for arrived and it is benign — $39B run-rate, supply leg removed — but "the auction looks well-set" was already the base case and is still not a trade. Nothing here is symbol-keyed or directional. | Nothing today; the next hard input is the 3Y auction result on **2026-09-08** |
| This week | Watch oil and the 9/8 3Y, not the Fed — no Fed voice is legal after 9/4 | Medium | Blackout begins **9/5**, so hike odds (~52–60%) are frozen until CPI moves them; the live variables are Brent above ~$95 into a Hormuz shock and OPEC+ on **9/6** (reportedly weighing a Q4 pause), plus the 3Y as the block's first demand read. | Brent falling back under ~$85 on a de-escalation, removing the inflation-uncertainty leg for the third time in this doc |
...
| This quarter | Two live channels now — Fed path and oil; the supply leg is closed | Medium | Supply is settled at run-rate, so what is left is the Fed path (Sep-16, hike ~52–60%, contested) and an Iran/Hormuz shock keeping the inflation-uncertainty leg in through the 9/11 CPI. Term premium persists (10Y ~4.78–4.79%, 30Y 5.24–5.27%) but no longer has a fresh supply catalyst. | A strong print (bid-to-cover ≥2.53, negative tail, indirects near/above 76%) on **2026-09-09** confirming demand is intact |
...
- **Fed silence** (added 9/4) — blackout begins **9/5**, so hike odds (~52–60%, contested) cannot be
  moved by a Fed voice before the auction. Between now and 1:00pm ET on 9/9 the only things that can
  reprice this event are **oil**, the **9/8 3Y result**, and positioning. That narrows the watch list.
- **Oil into the print** (added 9/4) — Brent at **~$95–96**, a six-week high, with Iran striking
  Kuwait, Jordan and Bahrain. Counterweight: Hormuz flows hit a **wartime-record ~17mb/d** under US
  escort (Energy Sec. Wright, 9/2). Sustained above ~$90 into 9/11 CPI keeps inflation uncertainty in.
