...
| 2026-09-22 | D-16 | **Deterministic screen (no Claude session).** Readings — VIX 14.9 (-2.2pt since last), band unchanged (medium:8+), 24 adjacent event(s) tracked, new in corridor since last pulse: `amzn-prime-big-deal-days-2026-10-06`, `jgb-10y-auction-2026-10-06`, `pjm-iras-ferc-deadline-2026-10-12`, `sudan-sanctions-regime-expiry-2026-10-09` (recorded, not assessed). Nothing tracked crossed its threshold. | — (screen; no assessment made) | 2026-09-29 |
