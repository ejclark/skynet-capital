...
|---|---|---|---|---|
| Today (D-13) | **Stand aside** | High | `symbols: []`, D-13, July data still does not exist (June remains the last published month), and a re-grep of `docs/plans/trade-playbooks.md` and `docs/research/multi-symbol-sweep.md` for any macro / housing / house-price keying returns **0 hits** again on **2026-09-16**. There is no trade in this print and no instrument on this calendar to express one. | A macro-keyed house playbook landing in `docs/plans/trade-playbooks.md` before **2026-09-29** — none exists today |
| This week | **Stand aside — and note that the newest edition is fifteen days old and nothing in this series prints before 09-29** | High | Current edition **2026-08-25** (June-2026 data): national NSA **+1.5% y/y**, 20-City **+2.1%**, 10-City **+2.9%**, national SA m/m **+0.1%** — all reconciled to FRED this session (1.525 / 2.096 / 2.914 / +0.134). Nominal y/y has now **accelerated four months running** from its **+0.78% March trough** (0.78 → 0.97 → 1.21 → **1.53**), which is the opposite of the deceleration story the sector tape tells — **and that divergence widened this week**: ITB **−5.10%** and XHB **−5.32%** from their 09-04 closes to 09-15 against SPY **−1.66%**, on two builder-specific down days (09-08 and 09-10). 30-year mortgage **6.76%** (w/e 2026-09-10, from 6.71% on 09-03); VIX **17.20** (2026-09-15, from 15.72 on 09-08). **FOMC lands 2026-09-16 and is unresolved as of this update.** | The 30-year mortgage rate breaking above **7.00%** or below **6.25%** before **2026-09-29** — either would break the slow-tightening transmission frame this row rests on; **24bp of headroom above as of w/e 09-10** |
...
- **"Not an FOMC day" is not "a clean slot" — and this is the second ledger in the family to have to
  say so.** **65** tracked events sit within five days of 09-29 as of **2026-09-16**, up from **41**
  on 09-09 and against **24** around 10-27; the `fhfa-hpi-2026-09-29` lane counted 32 on 2026-09-06
  and made the same point. Only **3** are confirmed high/critical — **PCE 09-30, ISM 10-01, jobs
  10-02** — which is the corridor that actually competes for attention.
...
| 2026-09-23 | D-6 | **Pulse. FOMC resolved — a HIKE, not a cut — and the mortgage kill switch is now the closest it has been to firing; the builder-vs-market divergence widened again.** Cadence unchanged (`low:0+`, still 7d). **Date — SUPPORTED, unchanged, now four-for-four.** cotality.com's own release page (fetched today) confirms the newest Case-Shiller release is still **June-2026 data, published 2026-08-25** — no early release, July still does not exist. FRED `CSUSHPINSA` corroborates: last observation still **2026-06 (336.663)**, unchanged from every prior row. **`FOMC (2026-09-16, high)` — the last row's open item — resolved to a 25bp HIKE to 3.75%–4.00%, the first hike since 2023** (federalreserve.gov/newsevents/pressreleases/monetary20260916a.htm), not the cut/hold this row's predecessor left unknown. **The mortgage kill switch is now the closest it has ever been to a boundary.** `MORTGAGE30US` (Freddie Mac PMMS via FRED) **jumped 6.76% (w/e 09-10) → 6.95% (w/e 09-17)**, +19bp the week of the hike — **only 5bp of headroom left under the 7.00% ceiling**, against 24bp last row. Neither boundary breached. **VIX fell despite the hike:** 17.20 (09-15) → **14.21 (09-22)**, **−2.99**, a hair under the 3-point screen bar (it spiked to 17.71 on the hike day itself, 09-16, then eased). **Builder-vs-market divergence widened again, sharply.** Since the 09-04 anchor: **SPY +0.43%** (770.19→773.50), **QQQ +3.13%** (718.96→741.47, +5.24% this week alone) against **ITB −6.08%** (93.91→88.20), **XHB −6.09%**, **LEN −6.58%** (83.58→78.08), **PHM −4.40%**, **TOL −4.40%**, **DHI −2.45%**, **XLRE −3.05%** — a **9.2pp gap between QQQ and ITB** that did not exist at the anchor. **Two builder earnings landed this week and both confirm order-side deceleration, with one genuine counter-note.** Lennar Q3 FY2026 (09-16 close; investors.lennar.com): orders **−9% y/y** to 20,879, EPS $1.23 adj. (**−38.5% y/y**), revenue −8.6% y/y, FY delivery guidance cut to 80–81k from 82–83k. **KB Home Q3 FY2026 (09-22 close; prnewswire.com / SEC 8-K) — the print last row's honest limit flagged as unreachable (403) and this lane did NOT file** — filed instead by a sibling lane as `kb-home-q3-fy2026-2026-09-22`: orders **−12% y/y** to 2,604 (worse than Lennar's), EPS $1.05, net income −41% y/y, **but ending backlog value +3%, its first backlog increase in four years.** Both orders prints deepen the demand-deceleration story feeding the `-3` seasonal-decay hazard; KBH's backlog uptick is a genuinely two-sided data point this ledger did not have before and is recorded, not resolved. **Detroit — still null, correctly.** `DEXRNSA` unchanged at 2026-05 against national 2026-06; no release has landed, so `-4` stays unscoreable and nothing is inferred from the non-move. **Adjacency: corridor essentially flat.** 65 named ids last row → **64 this row** (net: `opec-plus-meeting` rescheduled off 10-04 to 2026-11-01 and out of window; `retail-benchmark-revision-2026-09-28` no longer distinct from the already-tracked `census-benchmark-revision-nsa-2026-09-28`; one new duplicate id added, below). **Strong ids unchanged at 3** — `pce-2026-09-30`, `ism-manufacturing-2026-10-01`, `jobs-2026-10-02` — so the "dirtier slot" refutation holds without needing to move. **Calendar hygiene, observed not acted on:** the BEA international-transactions duplicate pair from last row now has a **third** copy, `us-iip-q2-2026-2026-09-24` (labelled TRIPLICATE by the scanner itself) — none of the three is this lane's file. **No new dated event discovered or proposed** — the corridor is fully tracked and every move above (FOMC, mortgage, VIX, equities, two earnings) is a standing series or an already-tracked print, not a new calendar event. **No forward test scoreable yet** (earliest is `-5`, score by 2026-09-30, the event-day ITB open gap — unreachable before the print itself) and none touched. **No new forward test registered** — the stance did not change and the mortgage/VIX/equity moves are already covered by the existing kill switches (`-1` through `-6`) rather than new falsifiable claims. | **No change — stand aside, thermometer never trigger.** The FOMC hiked rather than cut, and mortgage tightened to within 5bp of the `-1`-adjacent 7.00% ceiling — the closest this ledger has recorded — but neither boundary breached and the July print, the only thing any kill switch actually keys on, still does not exist. The move that matters most is still the **tape, not the index**: the SPY/QQQ-vs-homebuilder gap widened to 9.2pp since the anchor, on top of two builder earnings (Lennar, KB Home) both confirming order declines — which strengthens "thermometer" rather than eroding it. KB Home's backlog uptick is the one genuinely two-sided note, recorded and not resolved either way. Date rule reconfirmed at four consecutive last-Tuesdays; `symbols: []` inherited again; CME still unreachable, not re-attempted. | 2026-09-30 (low, 0+ band: every 7d — but the print itself lands 2026-09-29 first, so the next dispatch is more likely `event-passed-unscored` at D+1 than another pulse) |
| 2026-09-16 | D-13 | **Pulse. Stance survives unchanged; the one thing that moved is the tape, not the index.** Cadence crossed **`low:15+` → `low:0+`** (30d → 7d), which is why this row exists. **Date — SUPPORTED, and now OBSERVED rather than read.** press.spglobal.com's release index (HTTP 200, 117,083 bytes, fetched today) shows the newest Case-Shiller release is still **2026-08-25 (June data)**, and the last three are **2026-08-25 · 2026-07-28 · 2026-06-30 — every one the last Tuesday of its month**. Three-for-three observed compliance is a stronger basis for `-1` than the rule read once, and the FRED CSV corroborates that nothing has landed early (`CSUSHPINSA` still ends 2026-06). **Blocked and recorded, never substituted:** the date's second primary, `fred.stlouisfed.org/series/CSUSHPINSA`, now **fails to connect** from this runner on two attempts (30s and 45s) while the `fredgraph.csv` endpoint serves fine — so the *series page* joins the *release calendar* as unreadable here, and a future lane should reach for the CSV plus the press room, not the HTML series page. Also 403: `data.sec.gov` and `investor.kbhome.com`. **THE LAST ROW'S HONEST GAP IS CLOSED, AND IT IS WORSE THAN THE SIBLING MEASURED.** That row could only reach 2026-09-04 on equities and *cited* the 10-27 ledger for the 09-08 breakdown. Re-measured direct: 09-08 reproduces to two decimals (ITB **−3.05%**, LEN −3.84%, TOL −3.76%, PHM −3.52%, DHI −2.98% vs SPY −0.55%) — **and there was a second builder-specific down day no ledger in this family has recorded, 09-10** (ITB −2.31%, XHB −2.34%, LEN −3.54%, DHI −2.42%, TOL −1.90% vs SPY −0.60%). Cumulative from the 09-04 anchors to the 09-15 close: **ITB 93.91 → 89.12 = −5.10%**, XHB 103.25 → 97.76 **−5.32%**, TOL 141.73 → 134.20 **−5.31%**, LEN 83.58 → 80.07 **−4.20%**, PHM 124.45 → 119.47 **−4.00%**, DHI 142.75 → 140.20 −1.79%, XLRE 43.93 → 43.07 −1.96%, against **SPY 770.19 → 757.39 = −1.66%** and QQQ 718.96 → 704.54 −2.01%. **ITB is −3.44pp against SPY over eight sessions** — so the divergence the initial row named (nominal y/y accelerating while the sector tape tells a deceleration story) has widened rather than resolved, which is a fact about the *tape*, not about the index, and changes no call here. **Kill switches: none fired, one moved toward its boundary.** `MORTGAGE30US` **6.76%** (w/e 2026-09-10) from 6.71% (09-03) — the `This week` band is [6.25%, 7.00%] and there is **24bp of headroom**, direction consistent with the builder breakdown. VIX **17.20** (09-15) from **15.72** (09-08), **+1.48** — with a 17.84 print on 09-10 and a −11.2% collapse on 09-11 — **under** the 3-point screen bar, so this reading alone would not have bought a session. **Macro since the last row: August CPI landed 09-11 and the real-terms frame holds.** CPI m/m **+0.396%** (vs July +0.074%), y/y **3.353%**; against Case-Shiller's June NSA y/y **+1.525%**, real home values are still falling ~**1.83pp** y/y, so the publisher's *"13th consecutive month"* line needs CPI y/y under ~1.5% to break and is nowhere near it. **New, and it sharpens the headline hazard `-3` already names:** CPI's own housing channel *disagrees with this index by ~1.5pp* — shelter y/y **3.035%**, OER y/y **2.750%** vs 1.525% — because one measures lagged rents and the other transaction prices. A reader who treats either as "the housing number" on 09-29 gets the opposite story; that is a reading hazard, not an edge. **`FOMC IS TODAY (2026-09-16, high)` and its outcome is unknown at this row's timestamp** — it is the single most likely thing to move the mortgage rate through either boundary before 09-29 and is the next row's first item. **Adjacency: the corridor grew 41 → 65 in seven days (+24), which pushes the REFUTED "cleaner slot" claim further from rescue** — the proposal's own metric has moved 41→65 against 24 around 10-27. **Strong adjacents (confirmed high/critical within 5 days) = 3: `pce-2026-09-30`, `ism-manufacturing-2026-10-01`, `jobs-2026-10-02`** — this is the first pulse to populate `adjacentStrongIds`, which the initial probe-ref lacked entirely, so the *next* screen can diff against a filtered set instead of the whole churning corridor. Also newly in corridor and directly useful here: **`pmms-2026-10-01`**, the Freddie Mac survey this ledger's mortgage kill switch reads. **Calendar hygiene, observed not acted on** (neither file is this lane's): `bea-international-transactions-q2-2026-09-24` and `intl-transactions-q2-2026-09-24` appear to be the same BEA release under two ids, one canonical-confirmed and one proposal. **Detroit — null, and correctly so.** `DEXRNSA` still ends **2026-05**, `CSUSHPINSA` **2026-06**: the same one-month lag, unchanged because no release has landed. `-4` is not scoreable until after 09-29 and nothing was inferred from the non-move. **No forward test is scoreable and none was touched** — earliest score-by is 2026-09-30 (`-5`), the rest 2026-10-06. **No new forward test registered**, deliberately: the stance did not change and none of the above is a sharp falsifiable claim the six existing tests do not already cover. **ONE NEW DATED EVENT PROPOSED** — `proposals/lennar-q3-fy2026-2026-09-16.from-case-shiller-hpi-2026-09-29.json`, `estimate`, `sector`, `low`, `symbols: []`. Primary: investors.lennar.com's 2026-09-02 release (HTTP 200, 42,786 bytes), *"release its third quarter 2026 earnings after the market closes on September 16, 2026"*, call 09-17 11:00 ET. It closes a structural gap, not a line: **664 canonical events and six house-price ledgers whose instrument tables run on DHI/LEN/PHM/TOL/ITB/XHB, and not one homebuilder print tracked anywhere** — the family measures builder equities every pulse and has never had the demand print that moves them on its board. Lennar's quarter ended 2026-08-31 publishes orders, backlog, cancellations, ASP and incentive load: the first hard read on which of this row's two stories the tape is pricing, 13 days before this print. Filed `low`/`symbols: []`/`sector` on the `costco-q4-fy2026-2026-09-24` precedent (LEN is not a house name, 0 playbook hits re-grepped today, and `earnings-calendar.ts` is forbidden to this lane). **Declined so the absences read as decisions:** KB Home's Q3 date could not be pinned (403) and a builder print is not filed on seasonality alone; Lennar's Q4 likewise, and it sits past the 60-day horizon; the 11-24 and 12-29 editions stay declined per the 10-27 lane. **Honest limit on the proposal:** dated 2026-09-16 it is due on merge, so it buys a session at D-0 rather than a forward window — accepted knowingly, because the horizon leash (#2946) excludes only what can never become due. | **No change — stand aside, thermometer never trigger.** Nothing this pulse touches the mechanism the call rests on: no new index data exists (June is still the last published month), so the `-2` band **[−0.180%, +0.333%]** and the `-3` threshold **+0.554%** are unchanged and unchangeable until the release. The one real move is the **builder tape, not the index** — ITB −5.10% vs SPY −1.66% since the anchor, on **two** breakdown days (09-08 confirmed, **09-10 newly recorded**) — which widens the divergence the initial row named and reinforces "thermometer" rather than eroding it. Two supporting claims strengthen: the date rule is now **observed** on three consecutive last Tuesdays, not just read; and the **"cleaner slot" refutation** hardens as the corridor goes 41 → 65 against 10-27's 24. Kill switches all intact — mortgage 6.76% with 24bp of headroom, VIX +1.48 under the screen bar, CPI leaving the publisher's real-terms line untouched at ~−1.83pp. **FOMC today is unresolved at this timestamp and carries into the next row.** `symbols: []` inherited again; CME still unreachable, not re-attempted. | 2026-09-23 (low, 0+ band: every 7d) |
...
<!-- probe-ref: {"symbols":{},"vix":14.21,"daysBand":"low:0+","adjacentIds":["adp-employment-2026-09-30","advance-economic-indicators-2026-09-30","apple-eu-dma-terms-2026-10-01","bea-international-transactions-q2-2026-09-24","bloomberg-agg-index-rebalance-2026-09-30","boe-dmp-2026-10-02","boj-jgb-purchase-schedule-q4-2026-09-30","boj-summary-of-opinions-2026-10-01","boj-tankan-2026-10-01","census-benchmark-revision-nsa-2026-09-28","chicago-pmi-2026-09-30","construction-spending-2026-10-01","consumer-confidence-2026-09-29","costco-q4-fy2026-2026-09-24","crwv-fully-connected-2026-09-29","dallas-fed-mfg-2026-09-28","dallas-fed-trimmed-mean-2026-09-30","dallas-fed-tssos-2026-09-29","dmo-pilot-switch-auction-test-2026-09-24","durable-goods-2026-09-25","ecb-economic-bulletin-2026-09-24","eia-weekly-petroleum-status-2026-09-30","eurostat-hicp-flash-2026-10-01","fhfa-hpi-2026-09-29","g20-trade-ministerial-milwaukee-2026-09-30","gdp-q2-2026-third-2026-09-30","google-adtech-final-judgment-2026-10-02","government-funding-deadline-2026-09-30","intl-transactions-q2-2026-09-24","ism-manufacturing-2026-10-01","jgb-2y-auction-2026-09-30","jgb-40y-auction-2026-09-29","jgb-liquidity-enhancement-5-11y-2026-09-25","jobs-2026-10-02","jolts-2026-09-29","m3-full-report-2026-10-02","new-home-sales-2026-09-24","opec-jmmc-68th-2026-10-04","openai-devday-2026-09-29","pce-2026-09-30","pjm-reliability-backstop-procurement-2026-09-30","pmms-2026-10-01","russell-style-quarter-end-capping-effective-2026-09-30","scoos-2026-09-24","sp-global-manufacturing-pmi-2026-10-01","sp-global-pmi-commodity-price-supply-2026-10-01","sp-select-sector-secondary-reweight-2026-09-30","steel-imports-preliminary-2026-09-24","tic-quarterly-external-debt-2026-09-30","treasury-7y-note-2026-09-24","treasury-buyback-10y20y-2026-10-01","treasury-buyback-20y30y-2026-09-24","treasury-buyback-tips-1y10y-2026-09-29","treasury-coupon-announcement-2026-10-01","trump-xi-summit-2026-09-24","uk-consumer-confidence-2026-09-25","uk-electricity-vat-zero-rate-2026-10-01","uk-quarterly-national-accounts-2026-09-30","umich-sentiment-final-2026-09-25","unsc-haiti-gsf-mandate-adoption-2026-09-29","unsc-haiti-gsf-mandate-expiry-2026-09-30","unsc-iran-panel-mandate-expiry-2026-09-26","unsc-middle-east-2334-2026-09-28","us-iip-q2-2026-2026-09-24"],"adjacentStrongIds":["ism-manufacturing-2026-10-01","jobs-2026-10-02","pce-2026-09-30"],"screenStreak":0,"blocked":[{"url":"https://fred.stlouisfed.org/series/CSUSHPINSA","status":"CONNECT_FAILED","at":"2026-09-16"},{"url":"https://data.sec.gov/submissions/CIK0000920760.json","status":"403","at":"2026-09-16"},{"url":"https://investor.kbhome.com/","status":"403","at":"2026-09-16"},{"url":"https://alfred.stlouisfed.org/graph/fredgraph.csv?id=DEXRNSA&vintage_date=2026-08-25","status":"404","at":"2026-09-09"},{"url":"https://fred.stlouisfed.org/releases/calendar?rid=199","status":"NO_DATA_RENDERED","at":"2026-09-09"},{"url":"https://www.spglobal.com/spdji/en/index-family/indicators/sp-corelogic-case-shiller/","status":"403","at":"2026-09-09"},{"url":"https://www.cmegroup.com/markets/real-estate.html","status":"EGRESS_BLOCKED","at":"2026-09-09"}]} -->
