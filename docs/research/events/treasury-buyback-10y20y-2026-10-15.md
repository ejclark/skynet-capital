...
predicting an eligible count; its 20Y-exclusion mechanism survives 4 of 4 but takes no credit,
because the registration bound the two together. `FT-…-2` (full take on 10-15) is left exactly as
registered and is now expected to fail — stating that here is the honest move; editing the row would
be falsification. Two successors are registered below, written so neither depends on a dollar figure
that is no longer published in advance.
...
**Forward tests registered** in [`forward-tests/treasury-buyback-10y20y-2026-10-15.md`](../forward-tests/treasury-buyback-10y20y-2026-10-15.md).
The first two, from 2026-09-05:
...
Registered **2026-09-15**, after the 09-10 observation broke the base case both of those leaned on:

- **`FT-treasury-buyback-10y20y-2026-10-15-3`**, scoreable **2026-10-16** — the eligibility
  *mechanism*, stated without a count this time: the 10-15 eligible list contains **912810UT3** and
  excludes **912810UX4** and **912810UV8**.
- **`FT-treasury-buyback-10y20y-2026-10-15-4`**, scoreable **2026-10-16** — the spread-buying regime:
...
- ~~**The 2026-09-10 eligible list not containing 912810UT3 and 912810RT7, or not numbering 39**~~ —
  **FIRED 2026-09-10 on the count leg** (40, not 39; both named CUSIPs present, both excluded ones
  absent). `FT-…-1` scored KILL; this doc no longer predicts an eligible count. The mechanism claim
  it protected is re-registered count-free as `FT-…-3`.
- ~~**A second consecutive sub-$12B offer total (09-10 or 10-01)**~~ — **FIRED 2026-09-10** ($10.489B
  after $7.40B). Its stated consequence did *not* obtain: offers **rose**, and cover against the
  actual $6B maximum was **1.75x** — thin, not cleared-out. Recorded, not treated as a regime verdict.
- ~~**Treasury accepting materially less than the announced maximum on 09-10, 10-01 or 10-15**~~ —
  **FIRED 2026-09-10** ($5.187B of $6.000B, 86.4%). The 25-of-25 record is broken and the base case
  is flipped above; 2026-03-19 is no longer the lone exception.
- **The 2026-10-14 announcement printing a maximum below $4B, or the operation being pulled or
...
- ~~**Treasury escalating past $4B/op … or publishing the promised updated schedule**~~ — **FIRED
  twice**: the updated schedule published **2026-09-09**, and the 09-10 operation ran at **$6.000B**,
  50% above the floor. Its instruction to propose the escalation as a dated entry was **checked and
  already satisfied** — all twelve rows of the new schedule are tracked, as is
  `treasury-refunding-2026-11-04`. What remains live: **a maximum at or above $10B on 2026-10-14**,
  added sectors or frequency, or the increase being made permanent at the 2026-11-04 refunding.
