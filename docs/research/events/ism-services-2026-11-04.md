...
<!-- probe-ref: {"symbols":{},"vix":17.62,"daysBand":"high:21+","adjacentIds":["adp-employment-2026-11-04","boe-decision-2026-11-05","boj-decision-2026-10-30","boj-minutes-2026-11-05","chicago-pmi-2026-10-30","construction-spending-2026-11-02","ecb-spf-q4-2026-10-30","eci-q3-2026-10-30","intl-trade-full-report-2026-11-04","ism-manufacturing-2026-11-02","jgb-10y-auction-2026-11-05","jgb-climate-transition-5y-auction-2026-11-02","jobs-2026-11-06","jolts-2026-11-03","m3-full-report-2026-11-03","midterm-elections-2026-11-03","opec-plus-meeting-2026-11-01","productivity-costs-q3-2026-11-05","russell-style-month-end-capping-effective-2026-10-30","sloos-2026-11-02","treasury-3y-note-2026-11-09","treasury-borrowing-estimates-2026-11-02","treasury-buyback-10y20y-2026-11-04","treasury-buyback-1mo2y-2026-11-05","treasury-refunding-2026-11-04","uk-blue-book-2026-10-30","uk-pink-book-2026-10-30","umich-sentiment-prelim-2026-11-06","wholesale-trade-2026-11-09"],"adjacentStrongIds":["eci-q3-2026-10-30","jobs-2026-11-06"],"screenStreak":1} -->

## At a glance

**TL;DR.** **Stand aside — and this doc retires a claim this repo had been repeating rather than
restating it.** Three ledgers and this event's own calendar note assert that the ISM Services Prices
Index is "the single biggest non-CPI rate-path mover" we track. Measured across **all nine 2026
releases** (2026-09-03 added on the 09-08 pulse), it moves nothing on the leg the claim is about:
**TLT 4/9 up, mean +0.034%** against an unconditional −0.014%; **^TNX 4/9 up, mean −0.087%**. The
09-08 pulse tightened that, because the year's **hottest** Prices reading arrived and went the wrong
way: August **72.6** — highest since Aug 2022, the fifth ≥70 in six months — produced **^TNX
−0.709%** and **TLT +0.146%**, yields *down*. Conditioning on the lever itself separates nothing
(Prices ≥70: ^TNX 2/5 up, −0.056% · Prices <70: 2/4, −0.125%), and the Spearman ordering that was
merely insignificant at n=8 is now **zero and sign-flipped** (Prices↔^TNX +0.216 → **−0.033**).
Registered as **FT-ism-services-2026-11-04-1**, scored on the 10-05 print. **The equity side now has
its first loud readings and they are not this survey's:** 09-03 put **XLF at its own p90** and SPY at
**p82** — the first observation anywhere in the grid above p76 — on a session whose move was
**Waller's** (Sep hike odds 63.2% → 50–54%), and whose ISM impulse the intraday successor **FT-48**
measured as real, correctly signed, trivially small and **fully retraced within two bars**. The
claim's most-cited receipt still inverts (the 10Y closed 4.617 on 2026-08-05, *down* from 4.627), and
the [manufacturing sibling](ism-manufacturing-2026-11-02.md)'s loud bond leg is still **TLT's monthly
distribution** (**FT-38**, scored PASS 2026-09-02: a $0.315 distribution went ex on 09-01). What
actually distinguishes **11-04** has grown from one confound to a **stack of four**: ADP **08:15** ·
Treasury refunding **08:30** · international trade · the 10Y-20Y buyback — all before or around a
10:00 print, in a corridor that went from 5 tracked neighbours to **18**. Date is **estimate**.

| Horizon | Call | Confidence | Why | Proves it wrong |
|---|---|---|---|---|
| Today (D-57) | **Stand aside** | High | `symbols: []`, an `estimate` date 57 days out, no October consensus in existence, no macro-keyed house playbook — and a measured reaction function of nil across six instruments that got *stronger*, not weaker, when the year's hottest Prices print was added. | ismworld.org serving an ungated PMI calendar showing a November services date other than **2026-11-04** — re-fetched **2026-09-08**: the ROB path now 301s to `/reports/ism-pmi-reports/`, which still 302s to `ecommerce.ismworld.org/SSO/Login.aspx`. The gate moved; it did not open |
| This week | **Nothing to do — the next scoreable date is 10-05** | High | 09-03 came and went: the null's daily test (**FT-37**) **voided** on a Waller-contaminated tape, its intraday successor (**FT-48**) **passed**, and this pulse re-registers the question at the subcomponent level as **FT-ism-services-2026-11-04-1**. | `^TNX` closing **up by more than its own 2026 median \|move\| (0.627%)** on a **Prices ≥ 70** print on **2026-10-05** — the hawkish ordering exists after all and the retirement gets re-argued |
| This month | **Never attribute a 11-04 morning move to this print — the confound is now a stack of four** | High | ADP **08:15** · Treasury refunding **08:30** · international trade · the 10Y-20Y buyback all precede or share the 10:00 slot. Supply and labor, not the survey, own that morning. Confidence raised from Medium on the calendar, not on new argument. | Treasury moving or cancelling the **2026-11-04** refunding announcement, **and** ADP's own 09-30 release naming a November date other than 11-04 — both legs, since one alone leaves the stack standing |
| This quarter | **Stand aside — the corridor's positioning dates are 11-03 and 11-06, not this** | Medium | It reads into a decided FOMC (10-28), a priced PCE (10-29) and a resolved election (11-03), two days before October payrolls. Its informational share is capped from both sides, and the corridor grew from 5 tracked neighbours to 18. | An October services headline **outside 2026's 53.6–56.1 range** on **2026-11-04** — the base rates stop being the right prior and this doc is re-read from the national tape |
...
- **The "biggest non-CPI rate-path mover" claim is retired as unmeasured**, and the 09-03 print hardened the refusal: nine releases, six instruments, and the year's hottest Prices reading moved yields *down*.
- **The one loud release day belongs to a Fed governor, not to ISM.** 09-03 put XLF at p90 and SPY at p82 — on a 9–13pp dovish repricing, with the ISM impulse fully retraced within two intraday bars (**FT-48**).
- **Attribution discipline on 11-04, now a stack of four:** ADP 08:15 · refunding 08:30 · intl trade · 10Y-20Y buyback, all before or around 10:00. No 11-04 morning move is attributable to this print.
- **The manufacturing sibling's TLT finding should not be relied on** — a dividend artifact, confirmed prospectively (**FT-38**, PASS 2026-09-02: $0.315 ex 09-01).
- **Prices ≥ 70** (six of nine 2026 prints, now peaking at 72.6) → the hawkish services-inflation line; read it, size nothing to it. Measured: it does not order yields.
- **Employment sub-50 for a fifth straight reading** (45.2 Mar · 47.9 May · 47.4 Jul · 47.8 Aug) *against* an August payrolls beat of **+162k vs +55k** → the divergence widened on both sides at once; reads into 11-06 payrolls, not into a trade.
- **A sub-50 headline** on 10-05 or this print → 2026's expansion streak breaks and the base rates stop applying.
- **Watch (dated):** CPI **09-11** · FOMC **09-16** · funding deadline **09-30** (est) · ISM services **10-05** · **FOMC 10-28** · GDP+PCE **10-29** · ISM mfg + SLOOS + Treasury estimates **11-02** · **midterms 11-03** (est) · **ADP + refunding + this print 11-04** (est) · jobs **11-06** · CPI **11-10**.
...
set is **retired as unmeasured** — across all nine 2026 releases (2026-09-03 added on the 09-08
pulse) TLT ran 4/9 up at a mean of +0.034%, ^TNX 4/9 at −0.087%, and conditioning on the Prices
subcomponent the claim names separates nothing (Prices ≥70: ^TNX 2/5 up, −0.056%; Prices <70: 2/4,
−0.125%). This is a finding about the **release**, not about services inflation's importance to the
Fed, which this measurement does not test.

**Amended 2026-09-08, and it cuts against the doc's own prior wording:** the initial research's
"no instrument's release-day move exceeded the 82nd percentile" is **no longer true** — 2026-09-03
put **XLF at its own p90 (+1.561%)** and **SPY at p82 (+1.047%)**, the loudest readings in the grid.
That session is not evidence for this release: Governor Waller spoke 08:30 ET and September hike odds
fell 63.2% → 50–54%, and the intraday successor **FT-48** measured the ISM impulse in the release
hour as real, correctly signed, trivially small and **fully retraced within two bars** — yields rose
on hot Prices, gave it back, and closed −3.4bp. The daily-resolution claim is therefore restated
rather than repeated: **on the bond leg the null is stronger at n=9 than at n=8; on the equity leg
the loudest day we have is attributable to a Fed governor, and a daily window cannot separate the
two.** Additionally, and specific to this date: **attribute no bond move on the morning of 11-04 to
this print** — the confound is no longer one event but four, ADP at **08:15 ET**, Treasury's
Quarterly Refunding Announcement at **08:30**, the international-trade full report and the 10Y-20Y
buyback, all before or around the 10:00 slot; this is the same collision that contaminated the 08-05
release whose yield move a sibling ledger attributed to ISM Prices. Base case for the
...
- ~~**TLT or ^TNX prints a release-day |move| above its own 2026 p90 (1.04% / 1.52%) on
  2026-09-03**~~ — **spent 2026-09-04: FT-37 VOIDED, not scored.** The readings passed comfortably
  (TLT +0.146% vs 1.04%; ^TNX −0.709% vs 1.52%) but the void clause fired — Waller spoke 08:30 ET
  and hike odds moved 9–13pp, so the window was not measuring ISM. Its own scoring named the defect:
  a coarse "any macro headline" clause voids too often. Superseded below.
- **`^TNX` closes up by more than its own 2026 median |move| (0.627%) on a Prices ≥ 70 print on
  2026-10-05** — the Prices subcomponent orders yields after all, and the retirement of the
  "biggest non-CPI rate-path mover" claim gets re-argued from the tape rather than patched.
  Registered as **FT-ism-services-2026-11-04-1**, scored 2026-10-06, with FT-48's precise
  named-contaminant void clause in place of FT-37's coarse one.
...
- ~~**The manufacturing sibling's next pulse re-runs its bond leg on adjusted closes and reproduces
  the 8/8**~~ — **spent 2026-09-02: FT-38 SCORED PASS.** A TLT distribution went ex **2026-09-01 at
  $0.315**, inside the registered $0.28–$0.38 band, on the ISM Manufacturing release day — the
  eighth consecutive first-business-day ex-date of 2026. Re-run both ways, the nine release days are
  **raw 0/9 up, −0.544%** against **adjusted 3/9, −0.209%**. Leg 4 stands; the dividend explanation
  is confirmed prospectively, not merely in-sample.
...
| 2026-09-08 | D-57 | **The print this ledger was waiting on landed, and it made the refusal stronger on bonds and messier on equities.** **Date:** stays `estimate`. ISM's own August release (PRNewswire, dateline TEMPE, Ariz., 2026-09-03 10:00 ET, fetched today) re-states the cadence rule verbatim — "the third business day of every month after 10:00 a.m. ET," January excepted to the fourth — a **ninth** fetched dateline for leg 1, and names **only** its successor: "the next ISM Services PMI Report featuring September 2026 data will be released at 10:00 a.m. ET on Monday, October 5, 2026" (already tracked as `ism-services-2026-10-05`; Oct 1 Thu · 2 Fri · 5 Mon = third business day, consistent). It does not name November, so **no promotion**: Nov 1 is a Sunday, business days run Mon 11-02 · Tue 11-03 · Wed 11-04, and **11-04 stands on the rule alone**. ismworld.org re-fetched today — the old ROB path now **301s** to `/reports/ism-pmi-reports/`, which **302s** to `ecommerce.ismworld.org/SSO/Login.aspx` and then 404s. The gate moved; it did not open, so the `ISM:` confirmed prefix still needs a credentialed fetch this lane does not have. **The August print, from ISM's own text:** headline **55.4** (from 54.1, the 26th consecutive expansion month), Business Activity **61.7** (59.1), New Orders **60.9** (57.2), **Prices 72.6** (70.3) — the highest since Aug 2022 and the fifth ≥70 in six months — Employment **47.8** (47.4), Supplier Deliveries **51.3**, Backlog **55.6**. **Measurement re-run at n=9** (cache busted; Yahoo dividend-adjusted closes, 2026-01-01→09-08, n=169–172 sessions, six instruments vs the nine releases). **Bond leg — the null is STRONGER than at n=8:** TLT **4/9 up, mean +0.034%** vs an unconditional 48.5% / −0.014% (p=0.72); ^TNX **4/9, −0.087%** (p=0.79). 09-03 itself sat at TLT **p18** and ^TNX **p56**. **And the ordering the initial research conceded to the claim is gone.** Spearman(Prices, TLT) **−0.132 → −0.017**; Spearman(Prices, ^TNX) **+0.216 → −0.033** — zero, and now the *wrong* sign. Conditioning directly on the lever separates nothing: Prices ≥70 (n=5) gives ^TNX **2/5 up, −0.056%** and TLT **3/5, +0.072%**, against Prices <70 (n=4) at ^TNX **2/4, −0.125%** and TLT **1/4, −0.013%**. The most extreme observation cuts hardest against the claim: on the year's hottest Prices reading, **yields fell 0.709% and TLT rose 0.146%**. Registered **FT-ism-services-2026-11-04-1**, scored on the **10-05** print, with FT-48's precise named-contaminant void clause replacing FT-37's coarse one. **Equity leg — the doc's own "nothing above p76" line is now FALSE, and this row says so.** 09-03 put **XLF at its own p90 (+1.561%)** and **SPY at p82 (+1.047%)**, the two loudest readings anywhere in the 54-observation grid; XLF is now 7/9 up, mean +0.250% vs +0.043% unconditional (p=0.13, still nothing). **It is not this survey's day.** Governor Waller spoke **08:30 ET**, 90 minutes pre-release; September hike odds fell **63.2% (09-02) → 50–54%**, a 9–13pp swing, and the intraday successor **FT-48** (owned by the 12-03 sibling, PASSED 2026-09-04) measured the release hour on hourly bars: **nothing breached p90 on return or range in any of TLT · ^TNX · SPY · QQQ · IWM**, the ISM impulse arriving real, correctly signed and trivially small before retracing fully over two bars to close **−3.4bp**. XLF is the most rate-sensitive sector in the set and a dovish repricing is exactly what its p90 looks like. **Forward tests spent:** **FT-37 VOIDED 2026-09-04** — its readings passed (TLT +0.146% vs the registered 1.04% p90; ^TNX −0.709% vs 1.52%) but the void clause fired on Waller, and its own scoring named the defect: a coarse clause voids on any macro headline. **FT-38 SCORED PASS 2026-09-02** — a TLT distribution went ex **09-01 at $0.315**, inside the registered band, the eighth consecutive first-business-day ex-date; leg 4 confirmed prospectively. **Adjacency sweep — peers:** n/a, `symbols: []`. **Macro surprises, four since the last row:** (a) ISM **manufacturing** 09-01 **missed** — 54.6 vs 55.2, Employment 51.2 — the wrong direction for a hot-activity story; (b) **Waller 09-03 08:30 ET**, above; (c) this survey **hot**, above; (d) **August payrolls 09-04: +162k vs a +55k consensus, the largest upside surprise of the cycle**, July revised −23k → +21k and revisions **+55k combined upward** (carried from the [jobs close-out](jobs-2026-09-04.md), not re-derived). Hike odds ran 63.2% → 50–54% → **~59–60%** post-payrolls and resolve to a flat **58%** on 09-08, 12pp under the pre-Waller peak. **The stagflation divergence this doc tracks widened on both sides at once:** ISM services Employment printed sub-50 for a **fifth straight reading** (45.2 · 47.9 · 47.4 · 47.8) in the same week BLS printed the cycle's biggest beat — a contradiction to carry into 11-06, not a trade. **Volatility regime:** spot VIX **15.42** (Yahoo `^VIX`, 09-08 close) vs **15.39** at the last row — **+0.03pt, no regime break**, though it touched **16.34** on 09-01 intramonth. Futures **Sep 16.57 / Oct 18.41 / Nov 19.08 / Dec 19.26** (moomoo 09-01, carried from the [midterm ledger](midterm-elections-2026-11-03.md)) — the whole curve ~0.6–0.8 lower than the 08-25 reading leg 9 used, so the **November premium over spot narrows to ~3.7 points from ~4.3**. Leg 9's verdict is unchanged and slightly cheaper. **Geopolitical/policy:** carried, not re-derived — the OPEC+ seven-country group **held** on 09-06 and Brent still made a six-week high, with Hormuz transits at a four-month low ([OPEC close-out](opec-plus-meeting-2026-09-06.md), [3Y note](treasury-3y-note-2026-09-08.md)); crude → Prices-paid is the channel this survey's inflation line runs through, and 72.6 is consistent with it. Markets were **closed 09-07** (Labor Day). **Event tape:** still **no October consensus, whisper or bin** at D-57, and none will exist for weeks; ISM's own next release is 10-05. 2026 base rates updated — headline **53.8/56.1/54.0/53.6/54.5/54.0/54.1/55.4**, range **53.6–56.1 unchanged** (55.4 sits inside it, so the "This quarter" falsifier is untouched); Prices **66.6/63.0/70.7/70.7/71.3/67.7/70.3/72.6**, the range widening at the top to **63.0–72.6**. **Corridor: 5 tracked neighbours → 18** within ±5 days. The 11-04 morning is now a **stack of four** confounds, not one: **ADP 08:15 ET** · **Treasury refunding 08:30** · international-trade full report · the 10Y-20Y buyback, all before or around the 10:00 print. Leg 5's attribution rule holds a fortiori. **New dated adjacency: NONE — recorded as a negative result, not passed over.** Every date this sweep surfaced (10-05 services, 11-04 refunding, 11-04 ADP) is already a canonical calendar file. Specifically, the **ADP 11-04 08:15 ET slot this doc noted-but-deliberately-did-not-propose on 08-31** has since been filed canonically by the ADP lane from FRED rid=194 (fetched 2026-09-03) — the gap closed without this lane writing another owner's file, which is the one-file-per-owner rule working as designed. | **Refined, not reversed** — stand-aside holds at High. Bond-leg refusal strengthened at n=9 and re-registered at the subcomponent level (**FT-ism-services-2026-11-04-1**); the equity-leg wording **corrected** — "nothing above p76" is no longer true, and the loudest day we have belongs to Waller, not to ISM. "This month" raised Medium → High on the calendar (four confounds, not one), not on new argument. | 2026-09-15 (high, 21+ band: every 7d) |
| 2026-09-15 | D-50 | **Deterministic screen (no Claude session).** Readings — VIX 17.6 (+2.2pt since last), band unchanged (high:21+), 29 adjacent event(s) tracked, new in corridor since last pulse: `boe-decision-2026-11-05`, `ecb-spf-q4-2026-10-30`, `jgb-10y-auction-2026-11-05`, `jgb-climate-transition-5y-auction-2026-11-02`, `opec-plus-meeting-2026-11-01`, `russell-style-month-end-capping-effective-2026-10-30` +5 more (recorded, not assessed). Nothing tracked crossed its threshold. | — (screen; no assessment made) | 2026-09-22 |
| 2026-09-22 | D-43 | **Deterministic screen (no Claude session).** Readings — VIX 14.9 (-2.8pt since last), band unchanged (high:21+), 30 adjacent event(s) tracked, new in corridor since last pulse: `g20-foreign-ministers-atlanta-2026-10-30` (recorded, not assessed). Nothing tracked crossed its threshold. | — (screen; no assessment made) | 2026-09-29 |
...
<!-- probe-ref: {"symbols":{},"vix":14.87,"daysBand":"high:21+","adjacentIds":["adp-employment-2026-11-04","boe-decision-2026-11-05","boj-decision-2026-10-30","boj-minutes-2026-11-05","chicago-pmi-2026-10-30","construction-spending-2026-11-02","ecb-spf-q4-2026-10-30","eci-q3-2026-10-30","g20-foreign-ministers-atlanta-2026-10-30","intl-trade-full-report-2026-11-04","ism-manufacturing-2026-11-02","jgb-10y-auction-2026-11-05","jgb-climate-transition-5y-auction-2026-11-02","jobs-2026-11-06","jolts-2026-11-03","m3-full-report-2026-11-03","midterm-elections-2026-11-03","opec-plus-meeting-2026-11-01","productivity-costs-q3-2026-11-05","russell-style-month-end-capping-effective-2026-10-30","sloos-2026-11-02","treasury-3y-note-2026-11-09","treasury-borrowing-estimates-2026-11-02","treasury-buyback-10y20y-2026-11-04","treasury-buyback-1mo2y-2026-11-05","treasury-refunding-2026-11-04","uk-blue-book-2026-10-30","uk-pink-book-2026-10-30","umich-sentiment-prelim-2026-11-06","wholesale-trade-2026-11-09"],"adjacentStrongIds":["eci-q3-2026-10-30","jobs-2026-11-06"],"screenStreak":2} -->
