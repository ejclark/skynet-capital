...
- **The corridor is thin and dominated by something else** — **3** tracked ids within five days: `fomc-2027-12-08` (**high**, `estimate`) at **T−2**, `sp-rebalance-reference-close-2027-12-10` (proposal) on the **same session**, `vix-expiration-2027-12-15` (proposal) at T+5. An FOMC two sessions earlier will dominate any tape reading of 2027-12-10.
...
10. **The corridor is thin and dominated by something else — SUPPORTED.** **3** tracked ids sit within five days
    of 2027-12-10, computed from the calendar files: `fomc-2027-12-08` (**high**, `estimate`) at **T−2**,
    `sp-rebalance-reference-close-2027-12-10` (a sibling's proposal) on the **same session**, and
    `vix-expiration-2027-12-15` (proposal) at T+5. An FOMC decision two sessions earlier will dominate any tape
