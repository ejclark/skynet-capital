...
| 2026-08-26 | D0 | Final pre-auction pulse. Peers: no new tracked-name prints since 8/24; NVDA reports after this same auction. Macro: no CPI/jobs surprise since 8/19; Sep 15–16 FOMC odds have moved since the D2 row — now ~73% hold / 26% hike / 1% cut (Kalshi, checked today) vs. the ~60–70%/30–40%/~0% split the FOMC sibling doc carried — hold conviction firming and hike tail narrowing, still zero cut priced; direction of the leg-c correction (hot PCE → belly toward higher yields) stands. Separately, a same-window 10Y auction search (8/12/2026, most recent found) showed a $42B sale at 4.683% high yield — highest since 2007 — bid-to-cover 2.53x (vs ~2.47x 6mo avg), indirect bidders 76.7% (vs ~71.3% avg): stronger foreign demand than the 7/27 5Y's own soft indirect read (59.2% vs 65.7% avg), a cross-tenor divergence worth flagging rather than extrapolating from. Size/CUSIP for today's 5Y specifically still not independently confirmed this pass; $70B carried-forward pattern stands, to be checked at close-out. Volatility regime: VIX ~15.8 (Bespoke/Fed data, checked 8/25) — calm, no shift; SKEW last confirmed 142.93 (8/19), no fresher print, same gap as sibling docs. Geopolitical: Strait of Hormuz escalated further overnight (tanker hit by a projectile off Oman 8/25, engine disabled, crew safe) despite Trump's "demined" declaration — a fresh risk-premium input for energy-sensitive inflation expectations, not yet reflected in any auction result. Event tape: no auction result available yet (1pm ET, after this pulse ran). No new dated adjacency to propose. | — (watch-only stance holds; kill switches unfired) | 2026-08-27 (event now in the past; close-out expected once the scanner marks it event-passed-unscored) |
