...
| **sub-view** | a full view of its own | a nested route plus rail sub-nav | the desk's Pulse / Decisions / Thesis (`app/src/shell/desk-rail.tsx`; `/u/:id/playbooks` is now a redirect to R&D → Playbooks, #3623) |
