...
| Card | What it covers |
|---|---|
| [config-on-github](config-on-github.md) | What a diagram may set on GitHub's Mermaid 11.17.2 (frontmatter config, handDrawn, accTitle/accDescr, per-diagram keys, KaTeX), what the house declines and why (theme, ELK, icon packs, click, locked keys), and the validators: the pinned lint is the authority, the MCP runs 11.13.0 |
