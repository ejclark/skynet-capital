 ...
 *
 * This gate was written for the 2026-08-22 outage and pointed at `scripts/moneypenny/index.mjs` (then
 ...
 */
const GH_JSON_SCRIPTS = ["scripts/moneypenny/index.mjs", "scripts/feedback-scan.mjs"];
...
describe("gh --json fields", () => {
  ...
  it("never reads a state off a closing reference — gh does not return one", () => {
    const source = codeOnly(readFileSync("scripts/moneypenny/index.mjs", "utf8"));
