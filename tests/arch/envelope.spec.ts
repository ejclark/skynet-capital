...
import {
  ...
  suiteRunnerArgv,
} from "../../scripts/envelope-scan.mjs";
...
// path to additiveSafe:true, alongside pure insertion and safe structural widening: a diffAware
// rule's registered `invariantSuite`, untouched by the diff, passing right now.
