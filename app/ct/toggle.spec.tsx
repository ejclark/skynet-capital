...
/**
 * Proof-of-concept 1 of 3 (#3333 slice 3) — the smallest pure control in `shell/`, here to prove
 * the three things the harness has to do at all: mount a component with literal props, style it
 * from the app's real stylesheet, and carry a function prop back across the wire so an interaction
 * can be asserted. If this file is red, the harness is broken rather than the component.
 */
