...
// Playbook definitions (strategy templates), the Playbooks chapter of the Profile page's Milestones
// since #3807 slice 2b (was /playbooks) — static content, not live-ticking trading data
// (design decision 6 in the wider plan).
test.describe("playbooks", () => {
  test("renders the playbooks page", async ({ page }) => {
    await page.goto("/app/accounts?section=milestones&chapter=playbooks");
