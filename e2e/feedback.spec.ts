...
// The member's own feedback index, a viewer-level section of the Profile page since #3807 slice 2b
// (was /feedback) — config/history data, not live-ticking trading data (design
// decision 6 in the wider plan).
test.describe("feedback", () => {
  test("renders the feedback page", async ({ page }) => {
    await page.goto("/app/accounts?section=feedback");
